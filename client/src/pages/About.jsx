      ...
      <section className="section">
        ...
        <div className="privacy-list">
          ...
          <div className="card">
            ...
            <p>
              {t(
                "La commission vendeur est affichée avant la vente. Le parrainage client représente 2 % pour le vendeur référent, et les frais de livraison sont saisis au moment de la livraison. Les paiements sont directs et manuels, sans frais de plateforme."
              )}
            </p>
          </div>
        </div>
