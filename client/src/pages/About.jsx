      ...
      <section className="section">
        ...
        <div className="privacy-list">
          ...
          <div className="card">
            ...
            <p>
              {t(
                "La commission vendeur est affichée avant la vente. Le parrainage client représente 2 % pour le vendeur référent, et les frais de livraison sont saisis au moment de la livraison. Tous les paiements sont manuels et sans frais : l'acheteur paie le prix affiché."
              )}
            </p>
          </div>
        </div>
      ...
      <section className="section">
        ...
        <div className="steps">
          ...
          <div className="step">
            ...
            <p>
              {t(
                "Pour les paiements manuels (espèces à la livraison, Mobile Money ou virement bancaire), aucun frais n'est appliqué : l'acheteur paie le prix affiché, sans supplément."
              )}
            </p>
          </div>
        </div>
