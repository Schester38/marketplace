  ...
  if (error) {
    return (
      <main className="container narrow">
        ...
        <Link to="/createurs" className="btn btn-outline">← {t('Créateurs')}</Link>
      </main>
    );
  }
        ...
        <div className="shop-header">
          ...
          <div>
            <h2>
              {creator.name}
              {creator.verified && (
                <span className="badge badge-verified" title={t('Boutique vérifiée')}>✓ {t('Vérifiée')}</span>
              )}
            </h2>
            <p className="hint">
          ...
          {phone && (
            <a
              ...
              href={waLink(phone, t('Bonjour {shop}, je vous contacte depuis Mboppi.', { shop: creator.name }))}
              target="_blank"
