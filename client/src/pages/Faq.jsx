...
const FAQ_ITEMS = [
  ...
  {
    q: "Comment payer ?",
    a: "Aucune carte bancaire n'est nécessaire. Le paiement se fait directement avec le bénéficiaire : en espèces à la livraison, par virement Mobile Money direct ou par virement bancaire. Un paiement en ligne est aussi possible via Ikeepay pour les adhésions, les dons et les ventes ; dans ce cas, Ikeepay prélève 10% de frais de traitement.",
  },
  {
  ...
  },
  {
    ...
    a: "La boutique choisit un pourcentage de commission pour chaque produit. Ce pourcentage est affiché sur la fiche produit. Le vendeur reçoit le montant total moins la commission de la boutique. Votre commission est reversée automatiquement sur le numéro de mobile money enregistré dans votre espace. Pour les paiements en ligne, les frais Ikeepay (10%) sont déduits par le prestataire.",
  },
  {
    q: "Comment recevoir mes gains ?",
    a: "Enregistrez vos coordonnées de réception dans votre espace « Paiements ». Les paiements des commissions sont réalisés manuellement par la boutique, avec une preuve enregistrée sur la vente. Pour les paiements automatiques en ligne via Ikeepay, les frais de traitement de 10% sont déduits par Ikeepay ; vous recevez le montant net calculé par Mboppi.",
  },
  {
  ...
  },
  {
    ...
    a: "Lorsqu’un client s’inscrit avec le code vendeur d’un vendeur, il devient son client affilié. Les achats futurs de ce client génèrent 2 % pour le vendeur référent, sous réserve que la vente soit livrée. Le cumul est versé à partir de 5 000 XAF.",
  },
  {
  ...
  },
  {
    ...
    a: "Les paiements sont directs et manuels : espèces à la livraison, transfert Mobile Money direct ou virement bancaire, selon ce qui est convenu avec le bénéficiaire. Mboppi ne demande jamais de carte bancaire et ne collecte pas les paiements. Un paiement en ligne via Ikeepay est également possible pour les adhésions, les dons et les ventes ; Ikeepay prélève alors 10% de frais de traitement.",
  },
  {
