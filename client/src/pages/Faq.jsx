...
const FAQ_ITEMS = [
  ...
  {
    q: "Comment payer ?",
    a: "Aucune carte bancaire n'est nécessaire. Le paiement se fait directement avec le bénéficiaire : en espèces à la livraison, par virement Mobile Money direct ou par virement bancaire.",
  },
  {
  ...
  },
  {
    ...
    a: "La boutique choisit un pourcentage de commission pour chaque produit. Ce pourcentage est affiché sur la fiche produit. Le vendeur reçoit le montant total moins la commission de la boutique. Votre commission est reversée automatiquement sur le numéro de mobile money enregistré dans votre espace.",
  },
  {
    q: "Comment recevoir mes gains ?",
    a: "Enregistrez vos coordonnées de réception dans votre espace « Paiements ». Les paiements des commissions sont réalisés manuellement par la boutique, avec une preuve enregistrée sur la vente. Aucun frais de plateforme n’est déduit.",
  },
  {
