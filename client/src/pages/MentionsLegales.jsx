    ...
    <main className="container">
      ...
      <section className="privacy-list">
        ...
        <div className="card">
          ...
          <p>
            {t(
              "Les paiements peuvent être réalisés directement entre les parties par espèces, Mobile Money ou virement bancaire, ou via le prestataire Ikeepay pour les adhésions, les dons et les ventes. Mboppi ne prélève aucun frais de plateforme sur les transactions."
            )}
          </p>
        </div>
        <div className="card">
