    ...
    <main className="container">
      ...
      <section className="privacy-list">
        ...
        <div className="card">
          ...
          <p>
            {t(
              "Le paiement se fait directement avec la boutique, le vendeur ou le livreur : espèces à la livraison, Mobile Money direct ou virement bancaire. Mboppi ne prélève aucun frais de plateforme. Les paiements peuvent aussi être effectués via Ikeepay pour les adhésions, les dons et les ventes. Les frais de livraison sont indiqués sur chaque produit."
            )}
          </p>
        </div>
        <div className="card">
