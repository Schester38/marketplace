  ...
  return (
    <main className="container narrow">
      ...
      <div className="card suivi-card">
        ...
        <p className="hint">{t('Entrez votre code client (reçu avec votre commande) pour suivre son état.')}</p>
        <form onSubmit={submit} className="suivi-form">
          <input
            className="input"
            placeholder={t('Code client, ex : AB12CD3')}
            value={code}
          ...
          <div className="suivi-result">
            ...
            <div className="suivi-actions">
              ...
              <button
                ...
                onClick={async () => {
                  const url = `${BASE_URL}/suivi/${sale.id}?code=${sale.buyer_code || ''}`;
