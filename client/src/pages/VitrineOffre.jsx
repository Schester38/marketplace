...
export default function VitrineOffre() {
  ...
  const totalSavings = useMemo(
    () =>
      offers.reduce((sum, o) => sum + Math.max(0, Math.round(o.original_price - o.promo_price)), 0),
    [offers]
  );
    ...
    <main className="container">
      ...
      <section className="hero vitrine-hero">
        ...
        <div className="hero-stats">
          ...
          <div className="stat">
            <strong>
              {formatMoney(totalSavings)} {offerSymbol}
            </strong>
          ...
          <div className="ticker-track">
            {[...topOffers, ...topOffers].map((o, i) => (
              <span key={i} className="ticker-item">
                ...
                <b>
                  {formatMoney(o.promo_price)} {offerSymbol}
                </b>
              </span>
            ))}
          </div>
