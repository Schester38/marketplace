    ...
    <main className="container">
      ...
      <section className="privacy-list">
        ...
        <div className="card">
          ...
          <p>
            {t(
              "Les paiements sont convenus directement entre le client et la boutique, le vendeur ou le livreur. Les commissions sont enregistrées sur la plateforme et réglées manuellement par la boutique, sans frais de plateforme."
            )}
          </p>
        </div>
        <div className="card">
