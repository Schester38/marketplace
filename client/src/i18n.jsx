...
const EN = {
  ...
  "Votre nom *": "Your name *",
  "Votre email (optionnel)": "Your email (optional)",
  "Reçu et invitation à laisser un avis": "Receipt and review invitation",
...
const AR = {
  ...
  "Votre nom *": "اسمك *",
  "Votre email (optionnel)": "بريدك الإلكتروني (اختياري)",
  "Reçu et invitation à laisser un avis": "الإيصال ودعوة لترك تقييم",
...
const ES = {
  ...
  "Votre nom *": "Tu nombre *",
  "Votre email (optionnel)": "Tu correo electrónico (opcional)",
  "Reçu et invitation à laisser un avis": "Recibo e invitación a dejar una reseña",
...
const RICH_EN = {
  ...
  "Stockage Supabase": "Supabase storage",
...
const RICH_ES = {
  ...
  "Stockage Supabase": "Almacenamiento Supabase",
...
const RICH_AR = {
  ...
  "Stockage Supabase": "تخزين Supabase",
...
const GEN4_EN = {
  ...
  "Contenu conservé : seul le design change": "Content preserved: only the design changes",
...
const GEN5_EN = {
  ...
  "sauvegarde automatique activée": "autosave on",
  "modifications en cours": "unsaved changes",
  enregistré: "saved",
  Aperçu: "Preview",
  "Vérifier le document": "Check the document",
  Partager: "Share",
  "Lien de partage copié.": "Share link copied.",
  "Vue grille": "Grid view",
  "Vue liste": "List view",
  "Rechercher une page…": "Search a page…",
  "Ajouter une page": "Add a page",
  "Dupliquer cette page": "Duplicate this page",
  "Page ajoutée.": "Page added.",
  "Page dupliquée — textes, images et styles conservés.": "Page duplicated — texts, images and styles preserved.",
  "Pour une meilleure expérience de la plateforme, veuillez générer et éditer votre document sur Ordinateur. Merci !": "For a better platform experience, please generate and edit your document on a computer. Thanks!",
  "Page supprimée.": "Page deleted.",
  "Le document doit garder au moins une page.": "The document must keep at least one page.",
  "page(s) sélectionnée(s)": "page(s) selected",
  "Supprimer la sélection": "Delete selection",
  Désélectionner: "Clear selection",
  "Ajouter des éléments": "Add elements",
  "Texte et styles": "Text and styles",
  "Taille du texte": "Text size",
  "Sélection": "Selection",
  "Page entière": "Whole page",
  "Réduire la taille": "Decrease size",
  "Augmenter la taille": "Increase size",
  "La taille s'applique à tous les textes de la portée choisie — pas seulement à l'élément sélectionné.": "The size applies to every text in the chosen scope — not only the selected element.",
  "Taille inchangée (limites atteintes ou aucun texte dans la portée).": "Size unchanged (limits reached or no text in that scope).",
  "Taille du texte mise à jour": "Text size updated",
  "Tout le document en gras": "Bold the whole document",
  "Met en gras tous les textes du document, sauf les titres et les citations.": "Bolds all document text except titles and quotes.",
  "Document déjà en gras (hors titres et citations).": "The document is already bold (except titles and quotes).",
  "Gras appliqué au document": "Bold applied to the document",
  "Pour modifier un élément précis, sélectionnez-le sur la page.": "To edit a specific element, select it on the page.",
  "Ajusté à l'écran — l'export garde la taille réelle.": "Fitted to the screen — the export keeps the real size.",
  "Ajuster à la largeur de l'écran": "Fit to screen width",
  "élément(s)": "element(s)",
  "Vérifiez la portée : la modification ne s'appliquera qu'aux pages annoncées.": "Check the scope: the change will only be applied to the announced pages.",
  Calques: "Layers",
  "Modifier avec l'IA": "Edit with AI",
  "Mise en page de la page active": "Active page layout",
  Historique: "History",
  "Contrôle du document": "Document check",
  "Sélectionnez un texte sur la page.": "Select a text element on the page.",
  Police: "Font",
  Taille: "Size",
  Couleur: "Colour",
  Interligne: "Line spacing",
  "Éléments alignés": "Elements aligned",
  "Éléments distribués": "Elements distributed",
  "Distribuer ↔": "Distribute ↔",
  "Distribuer ↕": "Distribute ↕",
  "Sélectionnez au moins 3 éléments pour distribuer.": "Select at least 3 elements to distribute.",
  Monter: "Move up",
  Descendre: "Move down",
  Masquer: "Hide",
  Afficher: "Show",
  ...
  Coller: "Paste",
  Supprimer: "Delete",
  "Collé sur cette page.": "Pasted onto this page.",
  "Design uniquement": "Design only",
  "Contenu + design": "Content + design",
  "L'IA modifie la disposition, les couleurs, la typographie — jamais le texte.": "The AI changes layout, colours and typography — never the text.",
  "L'IA peut aussi réécrire, corriger, résumer le contenu.": "The AI may also rewrite, correct or summarise the content.",
  "Décrivez la modification souhaitée.": "Describe the change you want.",
  "Ex : Rends cette page plus moderne. / Corrige uniquement les fautes.": "E.g.: Make this page more modern. / Fix the typos only.",
  "Aperçu de la modification": "Preview change",
  "Modification appliquée.": "Change applied.",
  "Modification IA appliquée.": "AI change applied.",
  "IA indisponible": "AI unavailable",
  "L'IA n'a pas proposé de modification exploitable pour cette portée.": "The AI produced no usable change for that scope.",
  "l'IA respecte strictement la portée annoncée.": "the AI strictly follows the announced scope.",
  mots: "words",
  "Changer le design de cette page": "Change this page's design",
  "Suggestions intelligentes (contenu conservé)": "Smart suggestions (content preserved)",
  "Mise en page appliquée — contenu conservé.": "Layout applied — content preserved.",
  "Lancer la vérification": "Run the check",
  Score: "Score",
  "Aucun problème détecté.": "No issues found.",
  "Réduire l'espacement": "Reduce spacing",
  "Espacement réduit — vérifiez le résultat.": "Spacing reduced — check the result.",
  "Voir les solutions": "See solutions",
  "Aucune modification enregistrée.": "No change recorded yet.",
  Restaurer: "Restore",
  Rétablir: "Redo",
  Annuler: "Cancel",
  "Confirmation requise": "Confirmation required",
  "Vérifiez la portée : l'IA n'appliquera la modification qu'aux pages annoncées.": "Check the scope: the AI will only change the announced pages.",
  Appliquer: "Apply",
  "Modifier cette page": "Edit this page",
...
const GEN4_AR = {
  ...
  "Contenu conservé : seul le design change": "تم الحفاظ على المحتوى: يتغيّر التصميم فقط",
...
const GEN5_AR = {
  ...
  Document: "مستند",
  Enregistrer: "حفظ",
  "Document enregistré.": "تم حفظ المستند.",
  "Enregistrement impossible": "تعذّر الحفظ",
  "sauvegarde automatique activée": "الحفظ التلقائي مُفعَّل",
  "modifications en cours": "تغييرات غير محفوظة",
  enregistré: "محفوظ",
  Aperçu: "معاينة",
  "Vérifier le document": "فحص المستند",
  Partager: "مشاركة",
  "Lien de partage copié.": "تم نسخ رابط المشاركة.",
  "Vue grille": "عرض شبكي",
  "Vue liste": "عرض قائمة",
  "Rechercher une page…": "البحث عن صفحة…",
  "Ajouter une page": "إضافة صفحة",
  "Dupliquer cette page": "تكرار هذه الصفحة",
  "Page ajoutée.": "تمت إضافة الصفحة.",
  "Page dupliquée — textes, images et styles conservés.": "تم تكرار الصفحة — النصوص والصور والأنماط محفوظة.",
  "Pour une meilleure expérience de la plateforme, veuillez générer et éditer votre document sur Ordinateur. Merci !": "لتجربة أفضل على المنصة، يرجى إنشاء وتحرير مستندك على الكمبيوتر. شكرًا لك!",
  "Page supprimée.": "تم حذف الصفحة.",
  "Le document doit garder au moins une page.": "يجب أن يحتفظ المستند بصفحة واحدة على الأقل.",
  "page(s) sélectionnée(s)": "صفحات محدَّدة",
  "Supprimer la sélection": "حذف المحدَّد",
  Désélectionner: "إلغاء التحديد",
  "Ajouter des éléments": "إضافة عناصر",
  "Texte et styles": "النص والأنماط",
  "Taille du texte": "حجم النص",
  "Sélection": "التحديد",
  "Page entière": "الصفحة كاملة",
  "Réduire la taille": "تصغير الحجم",
  "Augmenter la taille": "تكبير الحجم",
  "La taille s'applique à tous les textes de la portée choisie — pas seulement à l'élément sélectionné.": "يُطبَّق الحجم على كل النصوص في النطاق المختار — لا على العنصر المحدَّد فقط.",
  "Taille inchangée (limites atteintes ou aucun texte dans la portée).": "لم يتغيّر الحجم (تم بلوغ الحدود أو لا يوجد نص في النطاق).",
  "Taille du texte mise à jour": "تم تحديث حجم النص",
  "Tout le document en gras": "تحديد المستند بالكامل بالخط العريض",
  "Met en gras tous les textes du document, sauf les titres et les citations.": "يجعل كل نصوص المستند عريضة، باستثناء العناوين والاقتباسات.",
  "Document déjà en gras (hors titres et citations).": "المستند عريض بالفعل (باستثناء العناوين والاقتباسات).",
  "Gras appliqué au document": "تم تطبيق الخط العريض على المستند",
  "Pour modifier un élément précis, sélectionnez-le sur la page.": "لتعديل عنصر محدد، حدّده في الصفحة.",
  "Ajusté à l'écran — l'export garde la taille réelle.": "مُكَيَّف مع الشاشة — يحتفظ التصدير بالحجم الحقيقي.",
  "Ajuster à la largeur de l'écran": "ملاءمة مع عرض الشاشة",
  "élément(s)": "عنصر",
  "Vérifiez la portée : la modification ne s'appliquera qu'aux pages annoncées.": "تحقّق من النطاق: لن يُطبَّق التعديل إلا على الصفحات المعلنة.",
  Calques: "الطبقات",
  "Modifier avec l'IA": "التعديل بالذكاء الاصطناعي",
  "Mise en page de la page active": "تنسيق الصفحة النشطة",
  Historique: "السجل",
  "Contrôle du document": "فحص المستند",
  "Sélectionnez un texte sur la page.": "حدِّد عنصر نص في الصفحة.",
  Police: "الخط",
  Taille: "الحجم",
  Couleur: "اللون",
  Interligne: "تباعد الأسطر",
  "Éléments alignés": "تمت محاذاة العناصر",
  "Éléments distribués": "تم توزيع العناصر",
  "Distribuer ↔": "توزيع ↔",
  "Distribuer ↕": "توزيع ↕",
  "Sélectionnez au moins 3 éléments pour distribuer.": "حدِّد 3 عناصر على الأقل للتوزيع.",
  Monter: "رفع",
  Descendre: "خفض",
  Masquer: "إخفاء",
  Afficher: "إظهار",
  ...
  Coller: "لصق",
  Supprimer: "حذف",
  "Collé sur cette page.": "تم اللصق في هذه الصفحة.",
  "Design uniquement": "التصميم فقط",
  "Contenu + design": "المحتوى + التصميم",
  "L'IA modifie la disposition, les couleurs, la typographie — jamais le texte.": "يغيّر الذكاء الاصطناعي التخطيط والألوان والخطوط — لا النص أبداً.",
  "L'IA peut aussi réécrire, corriger, résumer le contenu.": "يمكن للذكاء الاصطناعي أيضاً إعادة الصياغة والتصحيح والتلخيص.",
  "Décrivez la modification souhaitée.": "صِف التعديل المطلوب.",
  "Ex : Rends cette page plus moderne. / Corrige uniquement les fautes.": "مثال: اجعل هذه الصفحة أكثر عصرية. / صحِّح الأخطاء فقط.",
  "Aperçu de la modification": "معاينة التعديل",
  "Modification appliquée.": "تم تطبيق التعديل.",
  "Modification IA appliquée.": "تم تطبيق تعديل الذكاء الاصطناعي.",
  "IA indisponible": "الذكاء الاصطناعي غير متاح",
  "L'IA n'a pas proposé de modification exploitable pour cette portée.": "لم يقترح الذكاء الاصطناعي تعديلاً قابلاً للاستخدام ضمن هذا النطاق.",
  "l'IA respecte strictement la portée annoncée.": "يلتزم الذكاء الاصطناعي تماماً بالنطاق المعلن.",
  mots: "كلمات",
  "Changer le design de cette page": "تغيير تصميم هذه الصفحة",
  "Suggestions intelligentes (contenu conservé)": "اقتراحات ذكية (المحتوى محفوظ)",
  "Mise en page appliquée — contenu conservé.": "تم تطبيق التنسيق — المحتوى محفوظ.",
  "Lancer la vérification": "بدء الفحص",
  Score: "النتيجة",
  "Aucun problème détecté.": "لم يُكتشف أي مشكل.",
  "Réduire l'espacement": "تقليل التباعد",
  "Espacement réduit — vérifiez le résultat.": "تم تقليل التباعد — تحقّق من النتيجة.",
  "Voir les solutions": "عرض الحلول",
  "Aucune modification enregistrée.": "لا يوجد أي تعديل مسجَّل.",
  Restaurer: "استعادة",
  Rétablir: "إعادة",
  Annuler: "إلغاء",
  "Confirmation requise": "التأكيد مطلوب",
  "Vérifiez la portée : l'IA n'appliquera la modification qu'aux pages annoncées.": "تحقّق من النطاق: سيطبّق الذكاء الاصطناعي التعديل على الصفحات المعلنة فقط.",
  Appliquer: "تطبيق",
  "Modifier cette page": "تعديل هذه الصفحة",
  "Deux pages": "صفحتان",
  Mobile: "الهاتف",
  Page: "صفحة",
...
const GEN4_ES = {
  ...
  "Contenu conservé : seul le design change": "Contenido conservado: solo cambia el diseño",
...
const GEN5_ES = {
  ...
  Document: "Documento",
  Enregistrer: "Guardar",
  "Document enregistré.": "Documento guardado.",
  "Enregistrement impossible": "No se pudo guardar",
  "sauvegarde automatique activée": "guardado automático activado",
  "modifications en cours": "cambios sin guardar",
  enregistré: "guardado",
  Aperçu: "Vista previa",
  "Vérifier le document": "Comprobar el documento",
  Partager: "Compartir",
  "Lien de partage copié.": "Enlace para compartir copiado.",
  "Vue grille": "Vista de cuadrícula",
  "Vue liste": "Vista de lista",
  "Rechercher une page…": "Buscar una página…",
  "Ajouter une page": "Añadir una página",
  "Dupliquer cette page": "Duplicar esta página",
  "Page ajoutée.": "Página añadida.",
  "Page dupliquée — textes, images et styles conservés.": "Página duplicada — textos, imágenes y estilos conservados.",
  "Pour une meilleure expérience de la plateforme, veuillez générer et éditer votre document sur Ordinateur. Merci !": "Para una mejor experiencia de la plataforma, genere y edite su documento en un ordenador. ¡Gracias!",
  "Page supprimée.": "Página eliminada.",
  "Le document doit garder au moins une page.": "El documento debe conservar al menos una página.",
  "page(s) sélectionnée(s)": "página(s) seleccionada(s)",
  "Supprimer la sélection": "Eliminar la selección",
  Désélectionner: "Quitar selección",
  "Ajouter des éléments": "Añadir elementos",
  "Texte et styles": "Texto y estilos",
  "Taille du texte": "Tamaño del texto",
  "Sélection": "Selección",
  "Page entière": "Página completa",
  "Réduire la taille": "Reducir el tamaño",
  "Augmenter la taille": "Aumentar el tamaño",
  "La taille s'applique à tous les textes de la portée choisie — pas seulement à l'élément sélectionné.": "El tamaño se aplica a todos los textos del alcance elegido — no solo al elemento seleccionado.",
  "Taille inchangée (limites atteintes ou aucun texte dans la portée).": "Tamaño sin cambios (límites alcanzados o ningún texto en el alcance).",
  "Taille du texte mise à jour": "Tamaño del texto actualizado",
  "Tout le document en gras": "Poner todo el documento en negrita",
  "Met en gras tous les textes du document, sauf les titres et les citations.": "Pone en negrita todos los textos del documento salvo los títulos y las citas.",
  "Document déjà en gras (hors titres et citations).": "El documento ya está en negrita (salvo los títulos y las citas).",
  "Gras appliqué au document": "Negrita aplicada al documento",
  "Pour modifier un élément précis, sélectionnez-le sur la page.": "Para modificar un elemento concreto, selecciónalo en la página.",
  "Ajusté à l'écran — l'export garde la taille réelle.": "Ajustado a la pantalla — la exportación conserva el tamaño real.",
  "Ajuster à la largeur de l'écran": "Ajustar al ancho de la pantalla",
  "élément(s)": "elemento(s)",
  "Vérifiez la portée : la modification ne s'appliquera qu'aux pages annoncées.": "Comprueba el alcance: el cambio solo se aplicará a las páginas anunciadas.",
  Calques: "Capas",
  "Modifier avec l'IA": "Editar con la IA",
  "Mise en page de la page active": "Maquetación de la página activa",
  Historique: "Historial",
  "Contrôle du document": "Control del documento",
  "Sélectionnez un texte sur la page.": "Selecciona un texto en la página.",
  Police: "Fuente",
  Taille: "Tamaño",
  Couleur: "Color",
  Interligne: "Interlineado",
  "Éléments alignés": "Elementos alineados",
  "Éléments distribués": "Elementos distribuidos",
  "Distribuer ↔": "Distribuir ↔",
  "Distribuer ↕": "Distribuir ↕",
  "Sélectionnez au moins 3 éléments pour distribuer.": "Selecciona al menos 3 elementos para distribuir.",
  Monter: "Subir",
  Descendre: "Bajar",
  Masquer: "Ocultar",
  Afficher: "Mostrar",
  ...
  Coller: "Pegar",
  Supprimer: "Eliminar",
  "Collé sur cette page.": "Pegado en esta página.",
  "Design uniquement": "Solo diseño",
  "Contenu + design": "Contenido + diseño",
  "L'IA modifie la disposition, les couleurs, la typographie — jamais le texte.": "La IA cambia la disposición, los colores y la tipografía — nunca el texto.",
  "L'IA peut aussi réécrire, corriger, résumer le contenu.": "La IA también puede reescribir, corregir o resumir el contenido.",
  "Décrivez la modification souhaitée.": "Describe el cambio deseado.",
  "Ex : Rends cette page plus moderne. / Corrige uniquement les fautes.": "Ej.: Haz esta página más moderna. / Corrige solo las faltas.",
  "Aperçu de la modification": "Vista previa del cambio",
  "Modification appliquée.": "Cambio aplicado.",
  "Modification IA appliquée.": "Cambio de IA aplicado.",
  "IA indisponible": "IA no disponible",
  "L'IA n'a pas proposé de modification exploitable pour cette portée.": "La IA no propuso ningún cambio utilizable para ese alcance.",
  "l'IA respecte strictement la portée annoncée.": "la IA respeta estrictamente el alcance anunciado.",
  mots: "palabras",
  "Changer le design de cette page": "Cambiar el diseño de esta página",
  "Suggestions intelligentes (contenu conservé)": "Sugerencias inteligentes (contenido conservado)",
  "Mise en page appliquée — contenu conservé.": "Maquetación aplicada — contenido conservado.",
  "Lancer la vérification": "Iniciar la comprobación",
  Score: "Puntuación",
  "Aucun problème détecté.": "No se detectó ningún problema.",
  "Réduire l'espacement": "Reducir el espaciado",
  "Espacement réduit — vérifiez le résultat.": "Espaciado reducido — comprueba el resultado.",
  "Voir les solutions": "Ver las soluciones",
  "Aucune modification enregistrée.": "Ningún cambio registrado.",
  Restaurer: "Restaurar",
  Rétablir: "Rehacer",
  Annuler: "Cancelar",
  "Confirmation requise": "Confirmación necesaria",
  "Vérifiez la portée : l'IA n'appliquera la modification qu'aux pages annoncées.": "Comprueba el alcance: la IA solo aplicará el cambio a las páginas anunciadas.",
  Appliquer: "Aplicar",
  "Modifier cette page": "Editar esta página",
  "Deux pages": "Dos páginas",
  Mobile: "Móvil",
  Page: "Página",
