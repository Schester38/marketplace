...
const EN = {
  ...
  "Vendez où vous vivez, gardez 100 % de vos ventes.": "Sell where you live, keep 100% of your sales.",
  "0 % de frais de service. Publiez vos produits gratuitement et recevez vos commandes par téléphone ou WhatsApp.": "0% service fees. Publish your products for free and receive your orders by phone or WhatsApp.",
  "3 étapes pour commencer": "3 steps to get started",
  "Créez votre compte": "Create your account",
  "Choisissez le rôle « Vendeur », « Boutique » ou « Créateur » : inscription gratuite et sans engagement.": "Choose the “Seller”, “Shop” or “Creator” role: free sign-up, no commitment.",
  "Publiez ou partagez": "Publish or share",
  "Boutiques et créateurs publient leurs produits. Les vendeurs partagent leur code vendeur.": "Shops and creators publish their products. Sellers share their seller code.",
  ...
  "Vous gardez 100 % de vos ventes. Vendeur : 1 500 F / 30 jours. Boutique & créateur : gratuit.": "You keep 100% of your sales. Seller: 1,500 F / 30 days. Shop & creator: free.",
  "Parrainage = revenus complémentaires": "Referrals = extra income",
  "1 000 F par vendeur activé via votre lien + 2 % sur les achats de vos clients affiliés.": "1,000 F for each seller activated through your link + 2% on your affiliated clients' purchases.",
  ...
  "Vos clients commandent en quelques clics ou vous contactent directement sur WhatsApp.": "Your clients order in a few clicks or contact you directly on WhatsApp.",
...
const AR = {
  ...
  "Vendez où vous vivez, gardez 100 % de vos ventes.": "بِع حيث تعيش واحتفظ بـ100% من مبيعاتك.",
  "0 % de frais de service. Publiez vos produits gratuitement et recevez vos commandes par téléphone ou WhatsApp.": "0% رسوم خدمة. انشر منتجاتك مجاناً واستقبل طلباتك هاتفياً أو عبر واتساب.",
  "3 étapes pour commencer": "3 خطوات للبدء",
  "Créez votre compte": "أنشئ حسابك",
  "Choisissez le rôle « Vendeur », « Boutique » ou « Créateur » : inscription gratuite et sans engagement.": "اختر دور «بائع» أو «متجر» أو «صانع»: تسجيل مجاني دون أي التزام.",
  "Publiez ou partagez": "انشر أو شارك",
  "Boutiques et créateurs publient leurs produits. Les vendeurs partagent leur code vendeur.": "تنشر المتاجر والصنّاع منتجاتهم، ويشارك البائعون رمز البائع الخاص بهم.",
  ...
  "Vous gardez 100 % de vos ventes. Vendeur : 1 500 F / 30 jours. Boutique & créateur : gratuit.": "تحتفظ بـ100% من مبيعاتك. البائع: 1500 ف. / 30 يوماً. المتجر والصنّاع: مجاناً.",
  "Parrainage = revenus complémentaires": "الإحالة = دخل إضافي",
  "1 000 F par vendeur activé via votre lien + 2 % sur les achats de vos clients affiliés.": "1000 ف. عن كل بائع مُفعّل عبر رابطك + 2% على مشتريات عملائك المنتسبين.",
  ...
  "Vos clients commandent en quelques clics ou vous contactent directement sur WhatsApp.": "يطلب عملاؤك ببضع نقرات أو يتواصلون معك مباشرة على واتساب.",
...
const ES = {
  ...
  "Vendez où vous vivez, gardez 100 % de vos ventes.": "Vende donde vives, quédate con el 100% de tus ventas.",
  "0 % de frais de service. Publiez vos produits gratuitement et recevez vos commandes par téléphone ou WhatsApp.": "0% de comisión. Publica tus productos gratis y recibe tus pedidos por teléfono o WhatsApp.",
  "3 étapes pour commencer": "3 pasos para empezar",
  "Créez votre compte": "Crea tu cuenta",
  "Choisissez le rôle « Vendeur », « Boutique » ou « Créateur » : inscription gratuite et sans engagement.": "Elige el rol «Vendedor», «Tienda» o «Creador»: registro gratuito y sin compromiso.",
  "Publiez ou partagez": "Publica o comparte",
  "Boutiques et créateurs publient leurs produits. Les vendeurs partagent leur code vendeur.": "Las tiendas y creadores publican sus productos. Los vendedores comparten su código de vendedor.",
  ...
  "Vous gardez 100 % de vos ventes. Vendeur : 1 500 F / 30 jours. Boutique & créateur : gratuit.": "Conservas el 100% de tus ventas. Vendedor: 1500 F / 30 días. Tienda y creador: gratis.",
  "Parrainage = revenus complémentaires": "Referidos = ingresos extra",
  "1 000 F par vendeur activé via votre lien + 2 % sur les achats de vos clients affiliés.": "1000 F por cada vendedor activado con tu enlace + 2% en las compras de tus clientes afiliados.",
  ...
  "Vos clients commandent en quelques clics ou vous contactent directement sur WhatsApp.": "Tus clientes piden en unos clics o te contactan directamente por WhatsApp.",
