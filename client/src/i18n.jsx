...
const EN = {
  ...
  "VENDEURS INDÉPENDANTS": "INDEPENDENT SELLERS",
  ...
  "0 % de frais de service. Recevez votre code vendeur, partagez-le à vos contacts et encaissez vos commissions sur chaque vente — par téléphone ou WhatsApp.": "0% service fees. Get your seller code, share it with your contacts and collect your commissions on every sale — by phone or WhatsApp.",
  ...
  "Partagez votre code vendeur": "Share your seller code",
  "Un code unique à 6 caractères : vos clients l'utilisent pour commander et vos commissions sont calculées automatiquement.": "A unique 6-character code: your clients use it to order and your commissions are calculated automatically.",
...
const AR = {
  ...
  "VENDEURS INDÉPENDANTS": "بائعون مستقلون",
  ...
  "0 % de frais de service. Recevez votre code vendeur, partagez-le à vos contacts et encaissez vos commissions sur chaque vente — par téléphone ou WhatsApp.": "0% رسوم خدمة. احصل على رمز البائع الخاص بك، شاركه مع معارفك واحصل على عمولاتك عن كل عملية بيع — هاتفياً أو عبر واتساب.",
  ...
  "Partagez votre code vendeur": "شارك رمز البائع الخاص بك",
  "Un code unique à 6 caractères : vos clients l'utilisent pour commander et vos commissions sont calculées automatiquement.": "رمز فريد من 6 أحرف: يستخدمه عملاؤك للطلب وتُحتسب عمولاتك تلقائياً.",
...
const ES = {
  ...
  "VENDEURS INDÉPENDANTS": "VENDEDORES INDEPENDIENTES",
  ...
  "0 % de frais de service. Recevez votre code vendeur, partagez-le à vos contacts et encaissez vos commissions sur chaque vente — par téléphone ou WhatsApp.": "0% de comisión. Recibe tu código de vendedor, compártelo con tus contactos y cobra tus comisiones en cada venta — por teléfono o WhatsApp.",
  ...
  "Partagez votre code vendeur": "Comparte tu código de vendedor",
  "Un code unique à 6 caractères : vos clients l'utilisent pour commander et vos commissions sont calculées automatiquement.": "Un código único de 6 caracteres: tus clientes lo usan para pedir y tus comisiones se calculan automáticamente.",
