...
const EN = {
  ...
  "Commission vendeur ({symbol}) par article *": "Seller commission ({symbol}) per item *",
  "Commission pour les vendeurs ({symbol}) par article *": "Commission for sellers ({symbol}) per item *",
  "⚠️ La commission ne peut pas dépasser le prix de vente.": "⚠️ The commission cannot exceed the sale price.",
  "Le vendeur affichera : {price} {symbol} et gagnera {commission} {symbol} de commission par article vendu.": "The seller will see: {price} {symbol} and earn {commission} {symbol} commission per item sold.",
  ...
  "Produits publiés : {n}": "Published products: {n}",
  ...
  "Position du livreur actualisée toutes les 12 secondes pendant la livraison.":
    "Delivery driver's position refreshed every 12 seconds during delivery.",
  "Partager ma position au livreur": "Share my location with the driver",
  "Position partagée ✓ — le livreur peut vous localiser.":
    "Location shared ✓ — the driver can locate you.",
  "Localisation en cours…": "Locating…",
  "Position refusée ou indisponible.": "Location denied or unavailable.",
  "La géolocalisation n'est pas disponible sur cet appareil.":
    "Geolocation is not available on this device.",
  "Le livreur n'a pas encore activé le partage de sa position.":
  ...
  "Voir la carte de suivi GPS en temps réel": "View the real-time GPS tracking map",
  Suivi: "Track",
  "Partager ma position": "Share my location",
  "Arrêter le partage": "Stop sharing",
  "Arrêter": "Stop",
  "Partage de position en cours": "Location sharing in progress",
  "Votre position est partagée tant que cet écran reste ouvert. Le client, la boutique et le vendeur vous voient en temps réel.":
    "Your location is shared as long as this screen stays open. The client, the shop and the seller can see you in real time.",
  "Suivi GPS des livraisons": "GPS tracking of deliveries",
  "Aucune livraison en cours pour le moment.": "No deliveries in progress right now.",
  "En cours": "In progress",
  "Position livreur non partagée": "Driver location not shared",
  "Position livreur :": "Driver location:",
  Carte: "Map",
  "Arrêter le partage de position": "Stop sharing location",
  "Partager votre position GPS pendant la livraison":
    "Share your GPS location during the delivery",
  "Livreurs à proximité": "Nearby delivery drivers",
  "Boutiques à proximité": "Nearby shops",
  ...
  "Programmer la campagne": "Schedule the campaign",
  "Campagne programmée : elle partira automatiquement ce jour-là.": "Campaign scheduled: it will go out automatically on that day.",
  "Annuler cette campagne programmée ?": "Cancel this scheduled campaign?",
  "Campagne annulée.": "Campaign cancelled.",
  ...
  "aucune campagne due": "no campaign due",
  "Une campagne a déjà été envoyée aujourd'hui": "A campaign was already sent today",
  "Aucune campagne due aujourd'hui": "No campaign due today",
  ...
  "Boutiques actives": "Active shops",
  "Vendeurs & créateurs": "Sellers & creators",
  "Livreurs": "Delivery drivers",
  ...
  "3 étapes pour commencer": "3 steps to get started",
  "Créez votre compte": "Create your account",
  "Inscription gratuite et sans engagement : votre compte vendeur est prêt en moins d'une minute.": "Free sign-up, no commitment: your seller account is ready in under a minute.",
  "Payer votre adhésion à seulement 1500 F/mois. Partagez vos liens vendeur à vos contacts:": "Pay your membership for only 1,500 F/month. Share your seller links with your contacts:",
  "Un code unique à 6 caractères : vos clients l'utilisent pour consulter/commander et vos commissions sont calculées automatiquement.": "A unique 6-character code: your clients use it to browse/order and your commissions are calculated automatically.",
  ...
  "Réponse de repli (si l'IA échoue)": "Fallback reply (if the AI fails)",
  "Instructions supplémentaires pour l'IA (optionnel)": "Extra instructions for the AI (optional)",
...
"Espace livreur": "Delivery driver space",
  ...
  "{n} produit(s) trouvé(s)": "{n} product(s) found",
  "{n} derniers produits affichés sur {total}": "Latest {n} products shown of {total}",
  "{n} utilisateur(s) trouvé(s)": "{n} user(s) found",
  "{n} derniers utilisateurs affichés sur {total}": "Latest {n} users shown of {total}",
  ...
  "Photo ajoutée ✓ (cliquez pour changer)": "Photo added ✓ (click to change)",
  Preuve: "Proof",
  ...
  "Produits de": "Products from",
  "en premier": "first",
  "Tous les produits, partout": "All products, everywhere",
  "Tout voir": "See all",
  "Voir d'abord": "See first",
...
const AR = {
  ...
  "Commission vendeur ({symbol}) par article *": "عمولة البائع ({symbol}) لكل قطعة *",
  "Commission pour les vendeurs ({symbol}) par article *": "عمولة البائعين ({symbol}) لكل قطعة *",
  "⚠️ La commission ne peut pas dépasser le prix de vente.": "⚠️ لا يمكن أن تتجاوز العمولة سعر البيع.",
  "Le vendeur affichera : {price} {symbol} et gagnera {commission} {symbol} de commission par article vendu.": "سيظهر للبائع: {price} {symbol} وسيربح {commission} {symbol} عمولة عن كل قطعة مبيعة.",
  ...
  "Produits publiés : {n}": "المنتجات المنشورة: {n}",
  "Nouveau produit": "منتج جديد",
  "Modifier le produit": "تعديل المنتج",
  "Photos (maximum {n})": "الصور (بحد أقصى {n})",
  "Photo (1 max)": "صورة واحدة (كحد أقصى)",
  "Suivi en temps réel": "التتبع في الوقت الفعلي",
  "Position du livreur actualisée toutes les 12 secondes pendant la livraison.":
    "يتم تحديث موقع عامل التوصيل كل 12 ثانية أثناء التوصيل.",
  "Partager ma position au livreur": "مشاركة موقعي مع عامل التوصيل",
  "Position partagée ✓ — le livreur peut vous localiser.":
    "تمت مشاركة الموقع ✓ — يمكن لعامل التوصيل تحديد موقعك.",
  "Localisation en cours…": "جارٍ تحديد الموقع…",
  "Position refusée ou indisponible.": "تم رفض الموقع أو غير متوفر.",
  "La géolocalisation n'est pas disponible sur cet appareil.":
    "الموقع الجغرافي غير متوفر على هذا الجهاز.",
  "Le livreur n'a pas encore activé le partage de sa position.":
  ...
  "Voir la carte de suivi GPS en temps réel": "عرض خريطة تتبع GPS في الوقت الفعلي",
  Suivi: "تتبع",
  "Partager ma position": "مشاركة موقعي",
  "Arrêter le partage": "إيقاف المشاركة",
  Arrêter: "إيقاف",
  "Partage de position en cours": "مشاركة الموقع جارية",
  "Votre position est partagée tant que cet écran reste ouvert. Le client, la boutique et le vendeur vous voient en temps réel.":
    "يتم مشاركة موقعك طالما بقت هذه الشاشة مفتوحة. يمكن للعميل والمتجر والبائع رؤيتك في الوقت الفعلي.",
  "Suivi GPS des livraisons": "تتبع GPS للتوصيلات",
  "Aucune livraison en cours pour le moment.": "لا توجد عمليات توصيل جارية حالياً.",
  "En cours": "جارٍ",
  "Position livreur non partagée": "موقع عامل التوصيل غير مشارك",
  "Position livreur :": "موقع عامل التوصيل:",
  Carte: "خريطة",
  "Arrêter le partage de position": "إيقاف مشاركة الموقع",
  "Partager votre position GPS pendant la livraison": "مشاركة موقع GPS أثناء التوصيل",
  "Livreurs à proximité": "عوامل التوصيل القريبون",
  "Boutiques à proximité": "المتاجر القريبة",
  livreurs: "عوامل التوصيل",
  boutiques: "المتاجر",
  Moi: "أنا",
  ...
  "Programmer la campagne": "جدولة الحملة",
  "Campagne programmée : elle partira automatiquement ce jour-là.": "تمت جدولة الحملة: ستُرسل تلقائياً في ذلك اليوم.",
  "Annuler cette campagne programmée ?": "إلغاء هذه الحملة المجدولة؟",
  "Campagne annulée.": "تم إلغاء الحملة.",
  ...
  "jamais": "أبداً",
  "URL copiée": "تم نسخ الرابط",
  "Simulation OK": "المحاكاة ناجحة",
  "aucune campagne due": "لا توجد حملة مستحقة",
  "Une campagne a déjà été envoyée aujourd'hui": "أُرسلت حملة بالفعل اليوم",
  "Aucune campagne due aujourd'hui": "لا توجد حملة مستحقة اليوم",
  ...
  "Boutiques actives": "متاجر نشطة",
  "Vendeurs & créateurs": "بائعون وصنّاع",
  "Livreurs": "موصّلون",
  ...
  "3 étapes pour commencer": "3 خطوات للبدء",
  "Créez votre compte": "أنشئ حسابك",
  "Inscription gratuite et sans engagement : votre compte vendeur est prêt en moins d'une minute.": "تسجيل مجاني دون أي التزام: حسابك كبائع جاهز في أقل من دقيقة.",
  "Payer votre adhésion à seulement 1500 F/mois. Partagez vos liens vendeur à vos contacts:": "ادفع عضويتك بـ1500 ف. فقط في الشهر. شارك روابط البائع الخاصة بك مع معارفك:",
  "Un code unique à 6 caractères : vos clients l'utilisent pour consulter/commander et vos commissions sont calculées automatiquement.": "رمز فريد من 6 أحرف: يستخدمه عملاؤك للاطلاع/الطلب وتُحتسب عمولاتك تلقائياً.",
  ...
  "Réponse de repli (si l'IA échoue)": "الرد الاحتياطي (عند فشل الذكاء الاصطناعي)",
  "Instructions supplémentaires pour l'IA (optionnel)": "تعليمات إضافية للذكاء الاصطناعي (اختياري)",
  ...
  "Aucun utilisateur ne correspond à cette recherche.": "لا يوجد مستخدم مطابق لهذا البحث.",
  "{n} produit(s) trouvé(s)": "تم العثور على {n} منتج",
  "{n} derniers produits affichés sur {total}": "تم عرض آخر {n} منتج من أصل {total}",
  "{n} utilisateur(s) trouvé(s)": "تم العثور على {n} مستخدم",
  "{n} derniers utilisateurs affichés sur {total}": "تم عرض آخر {n} مستخدم من أصل {total}",
  ...
  "Produits de": "منتجات من",
  "en premier": "أولاً",
  "Tous les produits, partout": "كل المنتجات في كل مكان",
  "Tout voir": "عرض الكل",
  "Voir d'abord": "عرض أولاً",
  "Produits locaux": "المنتجات المحلية",
  "Le tunnel de paiement met trop de temps à répondre.":
...
const ES = {
  ...
  "Commission vendeur ({symbol}) par article *": "Comisión del vendedor ({symbol}) por artículo *",
  "Commission pour les vendeurs ({symbol}) par article *": "Comisión para los vendedores ({symbol}) por artículo *",
  "⚠️ La commission ne peut pas dépasser le prix de vente.": "⚠️ La comisión no puede superar el precio de venta.",
  "Le vendeur affichera : {price} {symbol} et gagnera {commission} {symbol} de commission par article vendu.": "El vendedor verá: {price} {symbol} y ganará {commission} {symbol} de comisión por artículo vendido.",
  ...
  "Produits publiés : {n}": "Productos publicados: {n}",
  "Nouveau produit": "Nuevo producto",
  "Modifier le produit": "Modificar el producto",
  "Photos (maximum {n})": "Fotos (máximo {n})",
  "Photo (1 max)": "Foto (máx. 1)",
  "Suivi en temps réel": "Seguimiento en tiempo real",
  "Position du livreur actualisée toutes les 12 secondes pendant la livraison.":
    "Posición del repartidor actualizada cada 12 segundos durante la entrega.",
  "Partager ma position au livreur": "Compartir mi ubicación con el repartidor",
  "Position partagée ✓ — le livreur peut vous localiser.":
    "Ubicación compartida ✓ — el repartidor puede localizarte.",
  "Localisation en cours…": "Localizando…",
  ...
  "Voir la carte de suivi GPS en temps réel": "Ver el mapa de seguimiento GPS en tiempo real",
  Suivi: "Seguir",
  "Partager ma position": "Compartir mi ubicación",
  "Arrêter le partage": "Detener el uso compartido",
  Arrêter: "Detener",
  "Partage de position en cours": "Uso compartido de ubicación en curso",
  "Votre position est partagée tant que cet écran reste ouvert. Le client, la boutique et le vendeur vous voient en temps réel.":
    "Tu ubicación se comparte mientras esta pantalla permanezca abierta. El cliente, la tienda y el vendedor pueden verte en tiempo real.",
  "Suivi GPS des livraisons": "Seguimiento GPS de las entregas",
  "Aucune livraison en cours pour le moment.": "No hay entregas en curso en este momento.",
  "En cours": "En curso",
  "Position livreur non partagée": "Ubicación del repartidor no compartida",
  "Position livreur :": "Ubicación del repartidor:",
  Carte: "Mapa",
  "Arrêter le partage de position": "Detener el uso compartido de la ubicación",
  "Partager votre position GPS pendant la livraison":
    "Comparte tu ubicación GPS durante la entrega",
  "Livreurs à proximité": "Repartidores cercanos",
  "Boutiques à proximité": "Tiendas cercanas",
  ...
  "Programmer la campagne": "Programar la campaña",
  "Campagne programmée : elle partira automatiquement ce jour-là.": "Campaña programada: saldrá automáticamente ese día.",
  "Annuler cette campagne programmée ?": "¿Cancelar esta campaña programada?",
  "Campagne annulée.": "Campaña cancelada.",
  "File d'attente": "Cola",
  "Envoyée": "Enviada",
  ...
  "jamais": "nunca",
  "URL copiée": "URL copiada",
  "Simulation OK": "Simulación OK",
  "aucune campagne due": "ninguna campaña pendiente",
  "Une campagne a déjà été envoyée aujourd'hui": "Ya se envió una campaña hoy",
  "Aucune campagne due aujourd'hui": "Ninguna campaña pendiente hoy",
  ...
  "Boutiques actives": "Tiendas activas",
  "Vendeurs & créateurs": "Vendedores y creadores",
  "Livreurs": "Repartidores",
  ...
  "3 étapes pour commencer": "3 pasos para empezar",
  "Créez votre compte": "Crea tu cuenta",
  "Inscription gratuite et sans engagement : votre compte vendeur est prêt en moins d'une minute.": "Registro gratuito y sin compromiso: tu cuenta de vendedor está lista en menos de un minuto.",
  "Payer votre adhésion à seulement 1500 F/mois. Partagez vos liens vendeur à vos contacts:": "Paga tu membresía por solo 1.500 F/mes. Comparte tus enlaces de vendedor con tus contactos:",
  "Un code unique à 6 caractères : vos clients l'utilisent pour consulter/commander et vos commissions sont calculées automatiquement.": "Un código único de 6 caracteres: tus clientes lo usan para ver/pedir y tus comisiones se calculan automáticamente.",
  ...
  "Réponse de repli (si l'IA échoue)": "Respuesta alternativa (si la IA falla)",
  "Instructions supplémentaires pour l'IA (optionnel)": "Instrucciones adicionales para la IA (opcional)",
...
"Espace livreur": "Espacio del repartidor",
  ...
  "{n} produit(s) trouvé(s)": "{n} producto(s) encontrado(s)",
  "{n} derniers produits affichés sur {total}": "{n} últimos productos mostrados de {total}",
  "{n} utilisateur(s) trouvé(s)": "{n} usuario(s) encontrado(s)",
  "{n} derniers utilisateurs affichés sur {total}": "{n} últimos usuarios mostrados de {total}",
  ...
  "Produits de": "Productos de",
  "en premier": "primero",
  "Tous les produits, partout": "Todos los productos, en todas partes",
  "Tout voir": "Ver todo",
  "Voir d'abord": "Ver primero",
  "Produits locaux": "Productos locales",
  "Le tunnel de paiement met trop de temps à répondre.":
...
const RICH_EN = {
  ...
  "Lorsqu’un client s’inscrit avec le code vendeur d’un vendeur, il devient son client affilié. Les achats futurs de ce client génèrent 2 % pour le vendeur référent, sous réserve que la vente soit livrée. Le cumul est versé à partir de 5 000 XAF.":
    "When a customer registers with a seller code, they become that seller’s affiliated customer. Future purchases generate 2% for the referring seller once delivered. The accumulated amount is paid from 5,000 XAF.",
...
const RICH_ES = {
  ...
  "Lorsqu’un client s’inscrit avec le code vendeur d’un vendeur, il devient son client affilié. Les achats futurs de ce client génèrent 2 % pour le vendeur référent, sous réserve que la vente soit livrée. Le cumul est versé à partir de 5 000 XAF.":
    "Cuando un cliente se registra con el código de un vendedor, pasa a ser su cliente afiliado. Sus compras futuras generan un 2 % para el vendedor referente una vez entregadas. El acumulado se paga desde 5.000 XAF.",
  "Oui pour un achat direct. Vous devez fournir votre nom, téléphone, ville et adresse, puis conserver le code de confirmation reçu. Un compte est nécessaire pour retrouver automatiquement l’historique de ses achats.":
...
// --- Générateur de documents : bibliothèque de modèles + IA livre ------------
const GEN2_EN = {
  "Toutes les catégories": "All categories",
  "Tous les styles": "All styles",
  Favoris: "Favorites",
  Récents: "Recent",
  "Rechercher un modèle…": "Search a template…",
  "Ajouter aux favoris": "Add to favorites",
  "Retirer des favoris": "Remove from favorites",
  "Aucun modèle ne correspond à ces filtres.": "No template matches these filters.",
  "Générer une variante": "Generate a variant",
  "Varie les couleurs, les polices et la couverture du modèle actif — votre contenu reste intact (réversible via Styles avancés).":
    "Varies the colors, fonts and cover of the active template — your content stays untouched (reversible via Advanced styles).",
  ...
  "Choisir un design": "Choose a design",
  Masquer: "Hide",
  ...
  "Suggestion indicative : les {n} modèles restent disponibles ci-dessous, et vos réglages de couleurs et de polices sont conservés.":
    "Indicative suggestion: all {n} templates remain available below, and your color and font settings are kept.",
  "Déposez votre fichier ici": "Drop your file here",
  "DOCX (Word), TXT ou Markdown — un document est créé puis analysé automatiquement.":
    "DOCX (Word), TXT or Markdown — a document is created then analyzed automatically.",
  "Choisir un fichier": "Choose a file",
  "… ou collez votre texte ici (la première ligne devient le titre)":
    "… or paste your text here (the first line becomes the title)",
  "Créer depuis le texte": "Create from text",
  "Formats acceptés : DOCX (Word), TXT ou Markdown.": "Accepted formats: DOCX (Word), TXT or Markdown.",
  "3 propositions de couverture": "3 cover proposals",
  "Trois palettes assorties au modèle actif — cliquez sur une pastille pour l'appliquer.":
    "Three palettes matching the active template — click a swatch to apply it.",
  "Appliquer cette couverture": "Apply this cover",
};

const GEN2_AR = {
  "Toutes les catégories": "كل الفئات",
  "Tous les styles": "كل الأنماط",
  Favoris: "المفضلة",
  Récents: "الأحدث",
  "Rechercher un modèle…": "البحث عن قالب…",
  "Ajouter aux favoris": "إضافة إلى المفضلة",
  "Retirer des favoris": "إزالة من المفضلة",
  "Aucun modèle ne correspond à ces filtres.": "لا يوجد قالب مطابق لهذه الفلاتر.",
  "Générer une variante": "إنشاء نسخة متنوعة",
  "Varie les couleurs, les polices et la couverture du modèle actif — votre contenu reste intact (réversible via Styles avancés).":
    "تنويع الألوان والخطوط والغلاف للقالب الحالي — يبقى المحتوى سليماً (يمكن التراجع عبر الأنماط المتقدمة).",
  "Analyse du document": "تحليل المستند",
  Chapitres: "الفصول",
  Sections: "الأقسام",
  Images: "الصور",
  Tableaux: "الجداول",
  ...
  "Choisir un design": "اختيار تصميم",
  Masquer: "إخفاء",
  ...
  "Suggestion indicative : les {n} modèles restent disponibles ci-dessous, et vos réglages de couleurs et de polices sont conservés.":
    "اقتراح إرشادي: تبقى جميع القوالب ({n}) متاحة أدناه، وتُحفظ إعدادات الألوان والخطوط لديك.",
  "Déposez votre fichier ici": "أفلِت ملفك هنا",
  "DOCX (Word), TXT ou Markdown — un document est créé puis analysé automatiquement.":
    "DOCX (Word) أو TXT أو Markdown — يُنشأ المستند ثم يُحلَّل تلقائياً.",
  "Choisir un fichier": "اختر ملفاً",
  "… ou collez votre texte ici (la première ligne devient le titre)":
    "… أو الصق نصك هنا (يصبح السطر الأول عنواناً)",
  "Créer depuis le texte": "إنشاء من النص",
  "Formats acceptés : DOCX (Word), TXT ou Markdown.": "الصيغ المقبولة: DOCX (Word) أو TXT أو Markdown.",
  "3 propositions de couverture": "3 اقتراحات للغلاف",
  "Trois palettes assorties au modèle actif — cliquez sur une pastille pour l'appliquer.":
    "ثلاث لوحات متناسقة مع القالب الحالي — انقر على لوحة لتطبيقها.",
  "Appliquer cette couverture": "تطبيق هذا الغلاف",
};

const GEN2_ES = {
  "Toutes les catégories": "Todas las categorías",
  "Tous les styles": "Todos los estilos",
  Favoris: "Favoritos",
  Récents: "Recientes",
  "Rechercher un modèle…": "Buscar una plantilla…",
  "Ajouter aux favoris": "Añadir a favoritos",
  "Retirer des favoris": "Quitar de favoritos",
  "Aucun modèle ne correspond à ces filtres.": "Ninguna plantilla coincide con estos filtros.",
  "Générer une variante": "Generar una variante",
  "Varie les couleurs, les polices et la couverture du modèle actif — votre contenu reste intact (réversible via Styles avancés).":
    "Varía los colores, las fuentes y la portada de la plantilla activa — tu contenido queda intacto (reversible vía Estilos avanzados).",
  ...
  "Choisir un design": "Elegir un diseño",
  Masquer: "Ocultar",
  ...
  "Suggestion indicative : les {n} modèles restent disponibles ci-dessous, et vos réglages de couleurs et de polices sont conservés.":
    "Sugerencia indicativa: las {n} plantillas siguen disponibles abajo, y tus ajustes de colores y fuentes se conservan.",
  "Déposez votre fichier ici": "Suelta tu archivo aquí",
  "DOCX (Word), TXT ou Markdown — un document est créé puis analysé automatiquement.":
    "DOCX (Word), TXT o Markdown — se crea un documento y se analiza automáticamente.",
  "Choisir un fichier": "Elegir un archivo",
  "… ou collez votre texte ici (la première ligne devient le titre)":
    "… o pega tu texto aquí (la primera línea se convierte en el título)",
  "Créer depuis le texte": "Crear desde el texto",
  "Formats acceptés : DOCX (Word), TXT ou Markdown.": "Formatos aceptados: DOCX (Word), TXT o Markdown.",
  "3 propositions de couverture": "3 propuestas de portada",
  "Trois palettes assorties au modèle actif — cliquez sur une pastille pour l'appliquer.":
    "Tres paletas a juego con la plantilla activa — haz clic en una muestra para aplicarla.",
  "Appliquer cette couverture": "Aplicar esta portada",
};

// Aperçu d'un modèle SANS l'appliquer (👁) — cahier des charges §17/18/62.
const GEN3_EN = {
  "Aperçu du modèle avec votre contenu": "Template preview with your content",
  ...
  "Votre contenu repaginé avec ce modèle — rien n'est modifié tant que vous ne cliquez pas sur « Utiliser ce modèle ».":
    "Your content re-paginated with this template — nothing is changed until you click “Use this template”.",
  ...
  "Aperçu des {n} premières pages sur {total} — le document complet sera mis en page exactement de la même façon.":
    "Preview of the first {n} pages out of {total} — the full document will be laid out exactly the same way.",
  "Aperçu impossible": "Preview unavailable",
};

const GEN4_EN = {
  "Recommandé pour votre contenu": "Recommended for your content",
  "Modèle appliqué : {v}": "Template applied: {v}",
  "Couleur d'accent : {v}": "Accent colour: {v}",
  "Police : {v}": "Font: {v}",
  "Interligne : {v}": "Line spacing: {v}",
  "Espacement des paragraphes augmenté": "Paragraph spacing increased",
  "{n} propositions de couverture": "{n} cover proposals",
  "Couleur de couverture appliquée": "Cover colour applied",
  "{n} variantes de design proposées": "{n} design variants proposed",
  "Contenu verrouillé : seul le design change": "Content locked: only the design changes",
  "Thème sombre": "Dark theme",
  "Thème clair": "Light theme",
  "Texte centré": "Centered text",
  "Texte aligné à gauche": "Left-aligned text",
  "Texte justifié": "Justified text",
  "Interligne : précisez une valeur entre 1,0 et 2,5.": "Line spacing: enter a value between 1.0 and 2.5.",
  "Le format se règle dans « Format et mise en page » (A4, A5, 6×9…).": "Format is set in “Format and layout” (A4, A5, 6×9…).",
  "Les marges se règlent dans « Format et mise en page ».": "Margins are set in “Format and layout”.",
  "Le style de couverture vient du modèle choisi — essayez « Générer une variante ».": "The cover style comes from the selected template — try “Generate a variant”.",
  "Le filigrane se règle dans la section Protection du document.": "The watermark is set in the Document protection section.",
  "Le QR code de vérification se règle dans la section Protection du document (ou avec le marqueur [QR]).": "The verification QR code is set in the Document protection section (or with the [QR] marker).",
  "Le copyright se règle dans la section Protection du document.": "Copyright is set in the Document protection section.",
  "La protection par code se fait à la vente (code de confirmation de l'acheteur), pas dans le PDF.": "Code protection happens at sale time (the buyer's confirmation code), not inside the PDF.",
  "L'alignement global n'a pas été modifié : les citations sont déjà mises en valeur par le modèle.": "Global alignment was not changed: quotes are already highlighted by the template.",
  "Rends le design plus moderne et professionnel.": "Make the design more modern and professional.",
  "Ajoute des couleurs bleu et blanc.": "Add blue and white colours.",
  "Utilise un style adapté à la finance.": "Use a style suited to finance.",
  "Fais-moi 3 variantes de design sans changer le contenu.": "Give me 3 design variants without changing the content.",
  "Crée trois couvertures différentes.": "Create three different covers.",
  "Commande de design": "Design command",
  "Appliquer la commande": "Apply command",
  "Commande non comprise : essayez par exemple « rends le design plus moderne et bleu ».": "Command not understood: try for example “make the design more modern and blue”.",
  "Appliquer cette variante": "Apply this variant",
  "Écrivez ce que vous voulez : le Générateur change le design, jamais votre texte.": "Write what you want: the Generator changes the design, never your text.",
  "Ex. : un design moderne, élégant, bleu et blanc, pour des entrepreneurs.": "E.g. a modern, elegant, blue-and-white design for entrepreneurs.",
  "{n} variantes — cliquez pour appliquer :": "{n} variants — click to apply:",
  Ebook: "Ebook",
  Rapport: "Report",
  Catalogue: "Catalogue",
  Livre: "Book",
...
const GEN3_AR = {
  "Aperçu du modèle avec votre contenu": "معاينة القالب مع محتواك",
  "Aperçu du modèle": "معاينة القالب",
  "Votre contenu repaginé avec ce modèle — rien n'est modifié tant que vous ne cliquez pas sur « Utiliser ce modèle ».":
    "تمت إعادة تقسيم محتواك بهذا القالب — لا يتغيّر شيء حتى تنقر على « استخدام هذا القالب ».",
  "Utiliser ce modèle": "استخدام هذا القالب",
  pages: "صفحات",
  "Aperçu des {n} premières pages sur {total} — le document complet sera mis en page exactement de la même façon.":
    "معاينة أول {n} صفحات من أصل {total} — سيُنسَّق المستند الكامل بالطريقة نفسها تماماً.",
  "Aperçu impossible": "المعاينة غير متاحة",
};

const GEN4_AR = {
  "Recommandé pour votre contenu": "مُقترَح لمحتواك",
  "Modèle appliqué : {v}": "تم تطبيق القالب: {v}",
  "Couleur d'accent : {v}": "لون التمييز: {v}",
  "Police : {v}": "الخط: {v}",
  "Interligne : {v}": "تباعد الأسطر: {v}",
  "Espacement des paragraphes augmenté": "تمت زيادة تباعد الفقرات",
  "{n} propositions de couverture": "{n} اقتراحات للغلاف",
  "Couleur de couverture appliquée": "تم تطبيق لون الغلاف",
  "{n} variantes de design proposées": "{n} نسخ تصميم مقترحة",
  "Contenu verrouillé : seul le design change": "المحتوى مقفل: يتغيّر التصميم فقط",
  "Thème sombre": "سمة داكنة",
  "Thème clair": "سمة فاتحة",
  "Texte centré": "نص في الوسط",
  "Texte aligné à gauche": "نص بمحاذاة اليسار",
  "Texte justifié": "نص مضبوط الحواف",
  "Interligne : précisez une valeur entre 1,0 et 2,5.": "تباعد الأسطر: أدخل قيمة بين 1,0 و2,5.",
  "Le format se règle dans « Format et mise en page » (A4, A5, 6×9…).": "يُضبط التنسيق في «التنسيق والتخطيط» (A4، A5، 6×9…).",
  "Les marges se règlent dans « Format et mise en page ».": "تُضبط الهوامش في «التنسيق والتخطيط».",
  "Le style de couverture vient du modèle choisi — essayez « Générer une variante ».": "يأتي نمط الغلاف من القالب المختار — جرّب «إنشاء نسخة مختلفة».",
  "Le filigrane se règle dans la section Protection du document.": "تُضبط العلامة المائية في قسم حماية المستند.",
  "Le QR code de vérification se règle dans la section Protection du document (ou avec le marqueur [QR]).": "يُضبط رمز QR للتحقق في قسم حماية المستند (أو باستخدام العلامة [QR]).",
  "Le copyright se règle dans la section Protection du document.": "تُضبط حقوق النشر في قسم حماية المستند.",
  "La protection par code se fait à la vente (code de confirmation de l'acheteur), pas dans le PDF.": "تتم الحماية بالرمز عند البيع (رمز تأكيد المشتري)، وليس داخل ملف PDF.",
  "L'alignement global n'a pas été modifié : les citations sont déjà mises en valeur par le modèle.": "لم تتغيّر المحاذاة العامة: القالب يُبرز الاقتباسات بالفعل.",
  "Rends le design plus moderne et professionnel.": "اجعل التصميم أكثر عصرية واحترافية.",
  "Ajoute des couleurs bleu et blanc.": "أضف ألواناً زرقاء وبيضاء.",
  "Utilise un style adapté à la finance.": "استخدم نمطاً مناسباً للمجال المالي.",
  "Fais-moi 3 variantes de design sans changer le contenu.": "أنشئ لي 3 نسخ تصميم دون تغيير المحتوى.",
  "Crée trois couvertures différentes.": "أنشئ ثلاثة أغلفة مختلفة.",
  "Commande de design": "أمر التصميم",
  "Appliquer la commande": "تطبيق الأمر",
  "Commande non comprise : essayez par exemple « rends le design plus moderne et bleu ».": "لم يُفهم الأمر: جرّب مثلاً «اجعل التصميم أكثر عصرية وزرقة».",
  "Appliquer cette variante": "تطبيق هذه النسخة",
  "Écrivez ce que vous voulez : le Générateur change le design, jamais votre texte.": "اكتب ما تريد: المولّد يغيّر التصميم فقط، وليس نصك.",
  "Ex. : un design moderne, élégant, bleu et blanc, pour des entrepreneurs.": "مثال: تصميم عصري وأنيق بالأزرق والأبيض لرواد الأعمال.",
  "{n} variantes — cliquez pour appliquer :": "{n} نسخ — انقر للتطبيق:",
  Ebook: "كتاب إلكتروني",
  Rapport: "تقرير",
  Catalogue: "كتالوج",
  Livre: "كتاب",
...
const GEN3_ES = {
  "Aperçu du modèle avec votre contenu": "Vista previa de la plantilla con tu contenido",
  "Aperçu du modèle": "Vista previa de la plantilla",
  "Votre contenu repaginé avec ce modèle — rien n'est modifié tant que vous ne cliquez pas sur « Utiliser ce modèle ».":
    "Tu contenido repaginado con esta plantilla — nada cambia hasta que hagas clic en « Usar esta plantilla ».",
  "Utiliser ce modèle": "Usar esta plantilla",
  pages: "páginas",
  "Aperçu des {n} premières pages sur {total} — le document complet sera mis en page exactement de la même façon.":
    "Vista previa de las primeras {n} páginas de {total} — el documento completo se maquetará exactamente igual.",
  "Aperçu impossible": "Vista previa no disponible",
};

const GEN4_ES = {
  "Recommandé pour votre contenu": "Recomendado para tu contenido",
  "Modèle appliqué : {v}": "Plantilla aplicada: {v}",
  "Couleur d'accent : {v}": "Color de acento: {v}",
  "Police : {v}": "Fuente: {v}",
  "Interligne : {v}": "Interlineado: {v}",
  "Espacement des paragraphes augmenté": "Espaciado entre párrafos aumentado",
  "{n} propositions de couverture": "{n} propuestas de portada",
  "Couleur de couverture appliquée": "Color de portada aplicado",
  "{n} variantes de design proposées": "{n} variantes de diseño propuestas",
  "Contenu verrouillé : seul le design change": "Contenido bloqueado: solo cambia el diseño",
  "Thème sombre": "Tema oscuro",
  "Thème clair": "Tema claro",
  "Texte centré": "Texto centrado",
  "Texte aligné à gauche": "Texto alineado a la izquierda",
  "Texte justifié": "Texto justificado",
  "Interligne : précisez une valeur entre 1,0 et 2,5.": "Interlineado: indica un valor entre 1,0 y 2,5.",
  "Le format se règle dans « Format et mise en page » (A4, A5, 6×9…).": "El formato se ajusta en «Formato y maquetación» (A4, A5, 6×9…).",
  "Les marges se règlent dans « Format et mise en page ».": "Los márgenes se ajustan en «Formato y maquetación».",
  "Le style de couverture vient du modèle choisi — essayez « Générer une variante ».": "El estilo de portada procede de la plantilla elegida — prueba «Generar una variante».",
  "Le filigrane se règle dans la section Protection du document.": "La marca de agua se ajusta en la sección Protección del documento.",
  "Le QR code de vérification se règle dans la section Protection du document (ou avec le marqueur [QR]).": "El código QR de verificación se ajusta en la sección Protección del documento (o con el marcador [QR]).",
  "Le copyright se règle dans la section Protection du document.": "El copyright se ajusta en la sección Protección del documento.",
  "La protection par code se fait à la vente (code de confirmation de l'acheteur), pas dans le PDF.": "La protección por código se realiza en la venta (código de confirmación del comprador), no dentro del PDF.",
  "L'alignement global n'a pas été modifié : les citations sont déjà mises en valeur par le modèle.": "La alineación global no se ha modificado: la plantilla ya destaca las citas.",
  "Rends le design plus moderne et professionnel.": "Haz el diseño más moderno y profesional.",
  "Ajoute des couleurs bleu et blanc.": "Añade colores azul y blanco.",
  "Utilise un style adapté à la finance.": "Usa un estilo adaptado a las finanzas.",
  "Fais-moi 3 variantes de design sans changer le contenu.": "Hazme 3 variantes de diseño sin cambiar el contenido.",
  "Crée trois couvertures différentes.": "Crea tres portadas diferentes.",
  "Commande de design": "Comando de diseño",
  "Appliquer la commande": "Aplicar comando",
  "Commande non comprise : essayez par exemple « rends le design plus moderne et bleu ».": "Comando no entendido: prueba por ejemplo «haz el diseño más moderno y azul».",
  "Appliquer cette variante": "Aplicar esta variante",
  "Écrivez ce que vous voulez : le Générateur change le design, jamais votre texte.": "Escribe lo que quieras: el Generador cambia el diseño, nunca tu texto.",
  "Ex. : un design moderne, élégant, bleu et blanc, pour des entrepreneurs.": "Ej.: un diseño moderno y elegante, azul y blanco, para emprendedores.",
  "{n} variantes — cliquez pour appliquer :": "{n} variantes — haz clic para aplicar:",
  Ebook: "Ebook",
  Rapport: "Informe",
  Catalogue: "Catálogo",
  Livre: "Libro",
...
export const I18N = {
  fr: {},
  en: { ...EN, ...RICH_EN, ...VIDEO_EN, ...GUEST_EN, ...GEN2_EN, ...GEN3_EN, ...GEN4_EN },
  ar: { ...AR, ...RICH_AR, ...VIDEO_AR, ...GUEST_AR, ...GEN2_AR, ...GEN3_AR, ...GEN4_AR },
  es: { ...ES, ...RICH_ES, ...VIDEO_ES, ...GUEST_ES, ...GEN2_ES, ...GEN3_ES, ...GEN4_ES },
};
