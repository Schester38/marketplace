  ...
  const badges = [
    {
      ...
      cls: "tb-orange",
      title: t("0 % de frais plateforme"),
      sub: t("Paiements directs entre parties"),
    },
    {
      icon: <IconBanknote size={22} />,
      cls: "tb-green",
      title: t("Paiement à la livraison"),
      sub: t("Espèces ou Mobile Money"),
    },
    {
      icon: <IconShieldCheck size={22} />,
      cls: "tb-blue",
      title: t("Boutiques vérifiées"),
      sub: t("Vendeurs identifiés et notés"),
    },
    {
      icon: <IconTruck size={22} />,
      cls: "tb-violet",
      title: t("Livraison suivie"),
      sub: t("Code de confirmation à la remise"),
    },
  ];
  return (
