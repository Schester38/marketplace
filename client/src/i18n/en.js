export default {
  ...
  "Le rôle Créateur est en cours de préparation : nous travaillons dessus et il sera bientôt disponible avec la gestion des paiements, la livraison et le suivi complet de vos ventes. En attendant, vos créations publiées restent visibles sur votre vitrine.":
    "The Creator role is being prepared: we are working on it and it will soon be available with payment management, delivery and full sales tracking. In the meantime, your published creations remain visible on your showcase.",
  ...
  "Je livre les commandes et je reçois mes frais de livraison directement":
    "I deliver orders and receive my delivery fees directly",
  "Enregistrez vos portefeuilles électroniques pour recevoir vos frais de livraison en ligne.":
    "Register your mobile wallets to receive your delivery fees online.",
  "C'est sur ce portefeuille que vos frais de livraison seront reversés automatiquement après chaque livraison payée en ligne.":
    "Delivery fees are automatically paid to this wallet after each online-paid delivery.",
  ...
  "Le montant est prélevé sur votre mobile money et reversé automatiquement sur les portefeuilles indiqués ci-dessous.":
    "The amount is debited from your mobile money and automatically paid to the wallets listed below.",
  ...
  "En attente — versement auto dès 5000 F": "Pending — automatic payout from 5,000",
  "Versement auto dès 5000 F": "Automatic payout from 5,000",
  ...
  "Chaque commande passée par un client inscrit avec votre lien vous rapporte 2% du montant. Le versement est automatique : vos commissions s'accumulent et sont payées sur votre portefeuille dès qu'elles atteignent 1500 F.":
    "Each order placed by a client registered with your link earns you 2% of the amount. Payout is automatic: your commissions accumulate and are paid into your wallet as soon as they reach 1,500 F.",
  ...
  "Signature du client (facultative)": "Customer signature (optional)",
  ...
  "Vous avez une somme à recevoir (vente #{sale}) mais aucun portefeuille valide n'est enregistré. Ajoutez un numéro sur votre page « Mes moyens de paiement ».":
    "You have money to receive (sale #{sale}) but no valid wallet is registered. Add a number on your « My payment methods » page.",
  ...
  "Le site est hébergé par Vercel Inc. (340 S Lemon Ave #4133, Walnut, CA 91789, États-Unis). La base de données PostgreSQL et le stockage des images sont assurés par Supabase Inc., 1111 Broadway, Suite 1355, Oakland, CA 94607, États-Unis.":
    "The website is hosted by Vercel Inc. (340 S Lemon Ave #4133, Walnut, CA 91789, USA). The PostgreSQL database and image storage are provided by Supabase Inc., 1111 Broadway, Suite 1355, Oakland, CA 94607, USA.",
  ...
  "Partagez ce lien : chaque vendeur qui s'inscrit via ce lien et active son compte (frais de 1500 F) vous fait gagner 1000 F, versés directement sur votre portefeuille Mobile Money.":
    "Share this link: every seller who signs up through it and activates their account (1500 F fee) earns you 1000 F, paid directly to your Mobile Money wallet.",
  "Deviens vendeur sur Mboppi avec mon lien et gagne le 1000 F offerts à chaque vendeur qui s'inscrit et active son compte via mon lien. Inscris-toi : {link}":
    "Become a seller on Mboppi with my link and earn 1000 F for every seller who signs up and activates their account through my link. Sign up: {link}",
  "Vous vous inscrivez via le lien de parrainage vendeur d'un vendeur Mboppi : le rôle « Vendeur » est sélectionné pour vous. Vous paierez les frais d'activation, et le vendeur qui vous a parrainé recevra 1000 F versés directement sur son portefeuille Mobile Money.":
    'You are registering through the seller referral link of an Mboppi seller: the "Seller" role is selected for you. You will pay the activation fee, and the seller who referred you receives 1000 F paid directly to their Mobile Money wallet.',
  ...
  "Lors de votre inscription : votre nom, votre e-mail et votre rôle (boutique, vendeur, client, livreur ou créateur). Si vous vous connectez avec Google, seul votre e-mail Google est utilisé. Selon votre rôle, vous pouvez publier des produits, des offres avec photos, et vos ventes sont enregistrées dans votre espace. Pour les paiements en ligne, nous n'utilisons que votre numéro de mobile money et votre opérateur, le temps du règlement.":
    "On registration: your name, email and role (shop, seller, client, delivery rider or creator). If you sign in with Google, only your Google email is used. Depending on your role, you can publish products and offers with photos, and your sales are recorded in your space. For online payments, we only use your mobile money number and operator, for the duration of the transaction.",
  ...
  "Enregistrez votre numéro de mobile money dans votre espace, page « Paiements » (boutique, vendeur ou livreur). Après chaque paiement confirmé, Mboppi reverse automatiquement votre part : le prix pour la boutique, la commission pour le vendeur, 2% pour le parrain et les frais pour le livreur.":
    "Register your mobile money number in your space, on the “Payments” page (shop, seller or rider). After each confirmed payment, Mboppi automatically transfers your share: the price for the shop, the commission for the seller, 2% for the sponsor and the fees for the rider.",
  ...
  "Rendez-vous sur la page « Soutenir Mboppi ». Les dons par Orange Money et MTN Mobile Money sont traités automatiquement en ligne ; les dons par PayPal ou par virement UBA se font manuellement.":
    "Go to the “Support Mboppi” page. Donations by Orange Money and MTN Mobile Money are processed automatically online; donations by PayPal or UBA transfer are done manually.",
  ...
  "C'est ce numéro que vos clients utilisent pour vous contacter sur WhatsApp depuis votre vitrine. Utilisez le format international (ex : +237 6 00 00 00 00).":
    "This is the number your clients use to contact you on WhatsApp from your showcase. Use the international format (e.g. +237 6 00 00 00 00).",
  ...
  "Trouvez les livreurs Mboppi disponibles pour vos livraisons et contactez-les directement.":
    "Find the Mboppi riders available for your deliveries and contact them directly.",
  ...
  "Laissez les champs vides pour afficher tous les livreurs disponibles.":
    "Leave the fields empty to show all available riders.",
  "Recherchez par ville et quartier pour trouver des livreurs.":
    "Search by city and neighbourhood to find riders.",
  ...
  Vérifié: "Verified",
  WhatsApp: "WhatsApp",
  "Bonjour {name}, je vous contacte depuis Mboppi.":
    "Hello {name}, I'm contacting you from Mboppi.",
  ...
  "Réglez vos frais d'activation pour commencer à vendre sur Mboppi.":
    "Pay your activation fee to start selling on Mboppi.",
  "Pour vendre sur Mboppi, réglez vos frais d'activation de {amount} {symbol}.":
    "To sell on Mboppi, pay your {amount} {symbol} activation fee.",
  ...
  "Votre espace vendeur est activé pendant {days} jours à compter du paiement.":
    "Your seller space is activated for {days} days from the payment.",
  ...
  "Confirmez sur votre téléphone. Nous vous redirigeons vers votre espace dès que le paiement est détecté.":
    "Confirm on your phone. We will redirect you to your space as soon as the payment is detected.",
  ...
  "Votre abonnement expire aujourd'hui. Pensez à le renouveler.":
    "Your subscription expires today. Remember to renew it.",
  ...
  "Partagez votre expérience avec nous sur Trustpilot":
    "Share your experience with us on Trustpilot",
  ...
  "Supprimer TOUTES les erreurs signalées ? Cette action est irréversible.":
    "Delete ALL reported errors? This action is irreversible.",

  // ===== Refonte visuelle 2026 : header / accueil / produit / dashboard =====
  "BIENVENUE SUR MBOPPI": "WELCOME TO MBOPPI",
  "Le marché de votre quartier, en ligne": "Your neighbourhood market, online",
  "Produits des boutiques, créations des créateurs, livraison près de chez vous.":
    "Shop products, creator creations, delivery near you.",
  "Découvrir les produits": "Explore products",
  "PROMOTIONS DU JOUR": "TODAY'S DEALS",
  "Offres éclair à durée limitée": "Limited-time flash deals",
  "Jusqu'à -50 % sur une sélection de produits. Une seule semaine par boutique : unique !":
    "Up to -50% on a selection of products. One week per shop only: unique!",
  "Voir les promotions": "See deals",
  "VENDEURS & BOUTIQUES": "SELLERS & SHOPS",
  "Vendez près de chez vous, sans frais de plateforme": "Sell near you, zero platform fees",
  "Publiez vos produits en quelques minutes et recevez vos commandes par téléphone ou WhatsApp.":
    "List your products in minutes and receive orders by phone or WhatsApp.",
  "Devenir vendeur": "Become a seller",
  "PROGRAMME DE PARRAINAGE": "REFERRAL PROGRAM",
  "Gagnez 2 % sur chaque achat de vos clients affiliés":
    "Earn 2% on every purchase from your affiliated customers",
  "Partagez votre code vendeur : vos clients achètent, vous touchez 2 % automatiquement.":
    "Share your seller code: your customers buy, you automatically earn 2%.",
  "Créer mon compte gratuit": "Create my free account",
  "À la une sur Mboppi": "Featured on Mboppi",
  "Diapositive précédente": "Previous slide",
  "Diapositive suivante": "Next slide",
  "Choisir une diapositive": "Choose a slide",
  Diapositive: "Slide",
  "Nos garanties": "Our guarantees",
  "0 % de frais plateforme": "0% platform fees",
  "Paiements directs entre parties": "Direct payments between parties",
  "Paiement à la livraison": "Cash on delivery",
  "Espèces ou Mobile Money": "Cash or Mobile Money",
  "Boutiques vérifiées": "Verified shops",
  "Vendeurs identifiés et notés": "Identified and rated sellers",
  "Livraison suivie": "Tracked delivery",
  "Code de confirmation à la remise": "Confirmation code on handover",
  "Défiler vers la gauche": "Scroll left",
  "Défiler vers la droite": "Scroll right",
  "Vendre sur Mboppi": "Sell on Mboppi",
  "Parcourir les catégories": "Browse categories",
  "Liens rapides": "Quick links",
  "Photos du produit": "Product photos",
  "Navigation du tableau de bord": "Dashboard navigation",
  "Indicateurs clés": "Key metrics",
  "Produits en ligne": "Products online",
  "Menu principal": "Main menu",
  "Langues disponibles": "Available languages",
  "Réseaux sociaux": "Social networks",
  "Activer le mode faible connexion (économie de données)": "Enable low-data mode (data saving)",
  "Mode faible connexion (économie de données)": "Low-data mode (data saving)",
  "Mode économie actif — cliquer pour désactiver": "Data-saving mode active — click to disable",
  /* fin refonte-A */

  // ===== Rattrapage : chaînes existantes non traduites =====
  "{n} vendus ce mois-ci": "{n} sold this month",
  "{n}% de réduction": "{n}% off",
  "Offre éclair": "Flash deal",
  "se termine le {date}": "ends on {date}",
  "Satisfait ou remboursé": "Money-back guarantee",
  "Charger la photo": "Load photo",
  "Promotions du jour": "Today's deals",
  "Des offres à durée limitée : dépêchez-vous !": "Limited-time deals: hurry up!",
  "Aucune promotion du jour pour le moment. Les boutiques peuvent en lancer une depuis leur espace.":
    "No deals today yet. Shops can launch one from their dashboard.",
  "Meilleures ventes": "Best sellers",
  "Tendances de la semaine": "Trending this week",
  "Vus récemment": "Recently viewed",
  "Reprenez là où vous vous étiez arrêté.": "Pick up where you left off.",
  "Vous n'avez pas encore consulté de produit.": "You haven’t viewed any product yet.",
  "Les produits les plus commandés.": "Most ordered products.",
  "Les produits les plus consultés ces 7 derniers jours.":
    "Most viewed products over the last 7 days.",
  "Les produits les plus consultés et commandés.": "Most viewed and ordered products.",
  "⭐ Populaire": "⭐ Popular",
  "Recherche…": "Search…",
  "Voir tous les résultats": "See all results",
  "Créateur·rice": "Creator",
  "Code livreur": "Courier code",
  "Code livreur généré : {code}": "Courier code generated: {code}",
  "Générer mon code livreur": "Generate my courier code",
  "Communiquez ce code à vos livreurs : en le saisissant sur la page Livraison, ils ne verront que les livraisons (en attente et effectuées) de votre boutique.":
    "Share this code with your couriers: entering it on the Delivery page shows them only your shop’s deliveries (pending and completed).",
  "Promotions éclair": "Flash deals",
  "Proposez un produit à durée limitée (24 h maximum, une promotion par semaine). Pendant la promotion, le produit disparaît du catalogue : seul l'accès à la promotion reste possible. À la fin du temps, la promotion disparaît et le produit réapparaît s'il reste en stock.":
    "Offer a product for a limited time (24 h max, one deal per week). During the deal the product is hidden from the catalogue: only the deal page stays reachable. When time runs out, the deal disappears and the product reappears if still in stock.",
  "Choisir un produit…": "Pick a product…",
  "⚡ Lancer la promotion": "⚡ Launch the deal",
  ...
  "6 heures": "6 hours",
  "12 heures": "12 hours",
  "Promotion éclair lancée !": "Flash deal launched!",
  "Rétirer cette promotion éclair ?": "Withdraw this flash deal?",
  "Promotion rétirée.": "Deal withdrawn.",
  "Lien de la promotion copié !": "Deal link copied!",
  "Aucune promotion éclair pour le moment.": "No flash deals right now.",
  "⚡ Offre éclair chez {shop} : {name} à {price} {symbol} au lieu de {old} {symbol} (-{pct}%) sur Mboppi.":
    "⚡ Flash deal at {shop}: {name} for {price} {symbol} instead of {old} {symbol} (-{pct}%) on Mboppi.",
  "Chiffre d'affaires ({symbol})": "Revenue ({symbol})",
  "Prix promo ({symbol})": "Deal price ({symbol})",
  "Commandes livrées": "Delivered orders",
  "Mes commandes livrées": "My delivered orders",
  "Mes produits": "My products",
  "Aucune commande en attente.": "No pending orders.",
  "Supprimer cette livraison « {name} » de mon espace ?":
    "Remove this delivery “{name}” from my space?",
  "Parrain payé ! La preuve a été enregistrée.": "Referrer paid! Proof has been saved.",
  "Produit « {name} » dupliqué. Pensez à modifier la copie.":
    "Product “{name}” duplicated. Remember to edit the copy.",
  "📋 Dupliquer": "📋 Duplicate",
  "Votre produit « {product} » a été supprimé : il ne respectait pas les CGU.":
    "Your product “{product}” was removed: it did not comply with the Terms of Sale.",
  "Votre produit « {product} » a été supprimé : il ne respectait pas les":
    "Your product “{product}” was removed: it did not comply with the",
};
