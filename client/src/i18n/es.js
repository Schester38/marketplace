export default {
  ...
  "Le rôle Créateur est en cours de préparation : nous travaillons dessus et il sera bientôt disponible avec la gestion des paiements, la livraison et le suivi complet de vos ventes. En attendant, vos créations publiées restent visibles sur votre vitrine.":
    "El rol de Creador está en preparación: estamos trabajando en ello y pronto estará disponible con la gestión de pagos, la entrega y el seguimiento completo de tus ventas. Mientras tanto, tus creaciones publicadas siguen visibles en tu vitrina.",
  ...
  "Je livre les commandes et je reçois mes frais de livraison directement":
    "Entrego los pedidos y recibo mis tarifas de entrega directamente",
  "Enregistrez vos portefeuilles électroniques pour recevoir vos frais de livraison en ligne.":
    "Registra tus billeteras electrónicas para recibir tus tarifas de entrega en línea.",
  "C'est sur ce portefeuille que vos frais de livraison seront reversés automatiquement après chaque livraison payée en ligne.":
    "Las tarifas de entrega se abonan automáticamente a esta billetera tras cada entrega pagada en línea.",
  ...
  "Le montant est prélevé sur votre mobile money et reversé automatiquement sur les portefeuilles indiqués ci-dessous.":
    "El importe se descuenta de tu dinero móvil y se abona automáticamente a las billeteras indicadas abajo.",
  ...
  "Chaque commande passée par un client inscrit avec votre lien vous rapporte 2% du montant. Le versement est automatique : vos commissions s'accumulent et sont payées sur votre portefeuille dès qu'elles atteignent 1500 F.":
    "Cada pedido hecho por un cliente registrado con tu enlace te reporta el 2% del importe. El pago es automático: tus comisiones se acumulan y se pagan en tu billetera en cuanto alcanzan los 1.500 F.",
  ...
  "Paiement à la livraison via iKeePay (Mobile Money)":
    "Pago a la entrega vía iKeePay (Dinero Móvil)",
  "Le livreur enverra une demande de paiement sur votre numéro mobile money à la livraison. Aucune carte bancaire n'est nécessaire.":
    "El repartidor enviará una solicitud de pago a tu número de dinero móvil en la entrega. No se necesita ninguna tarjeta bancaria.",
  "Paiement en ligne iKeePay indisponible actuellement. Contactez l'administration.":
    "El pago en línea iKeePay no está disponible actualmente. Contacta con la administración.",
  ...
  "Paiement sécurisé par iKeePay. Le client recevra une demande de paiement mobile money sur son téléphone. Confirmez l'opérateur et son numéro.":
    "Pago seguro con iKeePay. El cliente recibirá una solicitud de pago por dinero móvil en su teléfono. Confirma su operador y número.",
  Opérateur: "Operador",
  ...
  "Vous avez une somme à recevoir (vente #{sale}) mais aucun portefeuille valide n'est enregistré. Ajoutez un numéro sur votre page « Mes moyens de paiement ».":
    "Tienes dinero por recibir (venta #{sale}) pero no hay ninguna billetera válida registrada. Añade un número en tu página «Mis medios de pago».",
  ...
  "Le site est hébergé par Vercel Inc. (340 S Lemon Ave #4133, Walnut, CA 91789, États-Unis). La base de données PostgreSQL et le stockage des images sont assurés par Supabase Inc., 1111 Broadway, Suite 1355, Oakland, CA 94607, États-Unis.":
    "El sitio está alojado por Vercel Inc. (340 S Lemon Ave #4133, Walnut, CA 91789, Estados Unidos). La base de datos PostgreSQL y el almacenamiento de imágenes son provistos por Supabase Inc., 1111 Broadway, Suite 1355, Oakland, CA 94607, Estados Unidos.",
  ...
  "Partagez ce lien : chaque vendeur qui s'inscrit via ce lien et active son compte (frais de 1500 F) vous fait gagner 1000 F, versés directement sur votre portefeuille Mobile Money.":
    "Comparte este enlace: cada vendedor que se registra a través de él y activa su cuenta (cuota de 1500 F) te hace ganar 1000 F, pagados directamente en tu cartera Mobile Money.",
  "Deviens vendeur sur Mboppi avec mon lien et gagne le 1000 F offerts à chaque vendeur qui s'inscrit et active son compte via mon lien. Inscris-toi : {link}":
    "Hazte vendedor en Mboppi con mi enlace y gana los 1000 F ofrecidos por cada vendedor que se registra y activa su cuenta a través de mi enlace. Regístrate: {link}",
  "Vous vous inscrivez via le lien de parrainage vendeur d'un vendeur Mboppi : le rôle « Vendeur » est sélectionné pour vous. Vous paierez les frais d'activation, et le vendeur qui vous a parrainé recevra 1000 F versés directement sur son portefeuille Mobile Money.":
    "Te estás registrando a través del enlace de referidos de vendedores de un vendedor de Mboppi: el rol «Vendedor» está seleccionado para ti. Pagarás la cuota de activación, y el vendedor que te refirió recibe 1000 F pagados directamente en su cartera Mobile Money.",
  ...
  "Les règles pour utiliser Mboppi en tant que boutique, vendeur, client, livreur ou créateur.":
    "Las reglas para usar Mboppi como tienda, vendedor, cliente, repartidor o creador.",
  "Mboppi met en relation des boutiques, des vendeurs, des clients, des livreurs et des créateurs. Chaque compte est associé à un rôle qui détermine les fonctionnalités disponibles : publier des produits, vendre, commander, livrer ou créer.":
    "Mboppi conecta tiendas, vendedores, clientes, repartidores y creadores. Cada cuenta tiene un rol que determina las funciones disponibles: publicar productos, vender, pedir, repartir o crear.",
  "Le paiement s'effectue uniquement à la livraison du colis, par mobile money (Orange Money, MTN Mobile Money, etc.), via notre prestataire iKeePay. Le paiement est encaissé par iKeePay pour le compte de la boutique et du vendeur, puis Mboppi reverse automatiquement à chacun le montant qui lui revient.":
    "El pago se realiza únicamente a la entrega del paquete, por dinero móvil (Orange Money, MTN Mobile Money, etc.) a través de nuestro proveedor iKeePay. El pago lo cobra iKeePay por cuenta de la tienda y el vendedor, y luego Mboppi transfiere automáticamente a cada uno la cantidad que le corresponde.",
  ...
  "Les boutiques rémunèrent les vendeurs et les parrains par des commissions enregistrées sur la plateforme. Ces commissions sont reversées automatiquement sur le portefeuille mobile enregistré par chaque acteur. Les montants et les modalités de réclamation sont affichés dans les espaces vendeur, boutique et client.":
    "Las tiendas remuneran a los vendedores y padrinos con comisiones registradas en la plataforma. Estas comisiones se transfieren automáticamente a la cuenta de dinero móvil registrada por cada actor. Los importes y los procedimientos de reclamación se muestran en los espacios de vendedor, tienda y cliente.",
  ...
  "La livraison est assurée par la boutique ou par un livreur Mboppi. Les délais et les frais sont indiqués sur chaque produit et convenus lors de la commande. Le client paie à la livraison via iKeePay, et chaque acteur reçoit instantanément sa part sur son portefeuille mobile : la boutique le prix, le vendeur sa commission, le parrain son pourcentage et le livreur ses frais de livraison.":
    "El reparto lo realiza la tienda o un repartidor de Mboppi. Los plazos y gastos se indican en cada producto y se acuerdan al hacer el pedido. El cliente paga a la entrega vía iKeePay, y cada actor recibe al instante su parte en su cuenta de dinero móvil: la tienda el precio, el vendedor su comisión, el padrino su porcentaje y el repartidor sus gastos de entrega.",
  ...
  "La page « Soutenir Mboppi » permet de faire un don à la plateforme. Les dons par Orange Money et MTN Mobile Money sont traités automatiquement en ligne. Les dons par PayPal ou par virement UBA se font manuellement, en suivant les instructions de la page. Aucun don n'est obligatoire pour utiliser Mboppi.":
    "La página «Apoyar a Mboppi» permite donar a la plataforma. Las donaciones por Orange Money y MTN Mobile Money se procesan automáticamente en línea. Las donaciones por PayPal o transferencia UBA se hacen manualmente, siguiendo las instrucciones de la página. No es obligatorio donar para usar Mboppi.",
  ...
  "Mboppi ne peut être tenu responsable des produits vendus par les boutiques et vendeurs, ni des retards de livraison imputables aux livreurs. Les paiements en ligne sont exécutés par iKeePay, prestataire de paiement indépendant. Les informations publiées le sont par les vendeurs eux-mêmes.":
    "Mboppi no puede ser considerado responsable de los productos vendidos por tiendas y vendedores, ni de los retrasos de entrega atribuibles a los repartidores. Los pagos en línea los ejecuta iKeePay, un proveedor de pago independiente. La información publicada la aportan los propios vendedores.",
  ...
  "Seule la personne concernée accède à son espace : une boutique voit ses produits, un vendeur ses ventes et commissions. Les montants de vos paiements et versements ne sont visibles que dans votre espace. Les offres de la vitrine sont publiquement visibles par les visiteurs, mais sans vos informations de compte.":
    "Solo la persona interesada accede a su espacio: una tienda ve sus productos, un vendedor sus ventas y comisiones. Los importes de tus pagos y transferencias solo son visibles en tu espacio. Las ofertas de la vitrina son visibles públicamente para los visitantes, pero sin tu información de cuenta.",
  ...
  "Les paiements en ligne sont traités par iKeePay, prestataire de paiement mobile money. Ses conditions d'utilisation et sa politique de confidentialité s'appliquent au traitement des paiements effectués sur Mboppi.":
    "Los pagos en línea los procesa iKeePay, un proveedor de pago por dinero móvil. Sus términos de uso y su política de privacidad se aplican al procesamiento de los pagos realizados en Mboppi.",
  ...
  "Le paiement en ligne par mobile money est traité via notre prestataire iKeePay et reversé automatiquement à chaque acteur.":
    "El pago en línea por dinero móvil se procesa a través de nuestro proveedor iKeePay y se transfiere automáticamente a cada actor.",
  ...
  "Créez un compte gratuitement en moins d'une minute : choisissez votre rôle (boutique, vendeur, client, livreur ou créateur), renseignez votre nom et votre e-mail. Vous pouvez aussi vous connecter avec Google.":
    "Crea una cuenta gratis en menos de un minuto: elige tu rol (tienda, vendedor, cliente, repartidor o creador), introduce tu nombre y tu correo. También puedes iniciar sesión con Google.",
  ...
  "La boutique choisit un pourcentage de commission pour chaque produit. Ce pourcentage est affiché sur la fiche produit. Le vendeur reçoit le montant total moins la commission de la boutique. Votre commission est reversée automatiquement sur le numéro de mobile money enregistré dans votre espace.":
    "La tienda elige un porcentaje de comisión para cada producto. Este porcentaje se muestra en la ficha del producto. El vendedor recibe el importe total menos la comisión de la tienda. Tu comisión se transfiere automáticamente al número de dinero móvil registrado en tu espacio.",
  "Comment recevoir mes gains ?": "¿Cómo recibo mis ganancias?",
  "Enregistrez votre numéro de mobile money dans votre espace, page « Paiements » (boutique, vendeur ou livreur). Après chaque paiement confirmé, Mboppi reverse automatiquement votre part : le prix pour la boutique, la commission pour le vendeur, 2% pour le parrain et les frais pour le livreur.":
    "Registra tu número de dinero móvil en tu espacio, página «Pagos» (tienda, vendedor o repartidor). Tras cada pago confirmado, Mboppi transfiere automáticamente tu parte: el precio para la tienda, la comisión para el vendedor, el 2% para el padrino y los gastos para el repartidor.",
  "Comment soutenir Mboppi ?": "¿Cómo apoyo a Mboppi?",
  "Rendez-vous sur la page « Soutenir Mboppi ». Les dons par Orange Money et MTN Mobile Money sont traités automatiquement en ligne ; les dons par PayPal ou par virement UBA se font manuellement.":
    "Ve a la página «Apoyar a Mboppi». Las donaciones por Orange Money y MTN Mobile Money se procesan automáticamente en línea; las donaciones por PayPal o transferencia UBA se hacen manualmente.",
  ...
  "C'est ce numéro que vos clients utilisent pour vous contacter sur WhatsApp depuis votre vitrine. Utilisez le format international (ex : +237 6 00 00 00 00).":
    "Este es el número que tus clientes usan para contactarte por WhatsApp desde tu vitrina. Usa el formato internacional (p. ej.: +237 6 00 00 00 00).",
  ...
  "Trouvez les livreurs Mboppi disponibles pour vos livraisons et contactez-les directement.":
    "Encuentra los repartidores de Mboppi disponibles para tus entregas y contáctalos directamente.",
  Quartier: "Barrio",
  "Ex : Douala, Yaoundé…": "p. ej.: Duala, Yaundé…",
  "Ex : Bonamoussadi, Mvog-Mbi…": "p. ej.: Bonamoussadi, Mvog-Mbi…",
  "Laissez les champs vides pour afficher tous les livreurs disponibles.":
    "Deja los campos vacíos para mostrar todos los repartidores disponibles.",
  "Recherchez par ville et quartier pour trouver des livreurs.":
    "Busca por ciudad y barrio para encontrar repartidores.",
  "Aucun livreur trouvé pour ces critères.":
    "No se encontró ningún repartidor para estos criterios.",
  ...
  "Aucun opérateur iKeePay disponible pour ce pays":
    "Ningún operador de iKeePay disponible para este país",
  ...
  "Ce portefeuille servira à régler vos frais d'activation et à recevoir vos commissions.":
    "Este monedero se usará para pagar tu tarifa de activación y para recibir tus comisiones.",
  Activation: "Activación",
  "Activation de mon espace vendeur": "Activación de mi espacio de vendedor",
  "Réglez vos frais d'activation pour commencer à vendre sur Mboppi.":
    "Paga tu tarifa de activación para empezar a vender en Mboppi.",
  "Pour vendre sur Mboppi, réglez vos frais d'activation de {amount} {symbol}.":
    "Para vender en Mboppi, paga tu tarifa de activación de {amount} {symbol}.",
  "Frais d'activation Mensuelle": "Tarifa de activación mensual",
  "Votre espace vendeur est activé pendant {days} jours à compter du paiement.":
    "Tu espacio de vendedor se activa durante {days} días a partir del pago.",
  ...
  "Confirmez sur votre téléphone. Nous vous redirigeons vers votre espace dès que le paiement est détecté.":
    "Confirma en tu teléfono. Te redirigimos a tu espacio en cuanto se detecte el pago.",
  "En attente du paiement…": "Esperando el pago…",
  "Demande de paiement en cours d'envoi…": "Enviando la solicitud de pago…",
  "Le paiement n'a pas été effectué. Veuillez essayer à nouveau.":
  ...
  "Votre abonnement expire aujourd'hui. Pensez à le renouveler.":
    "Tu suscripción caduca hoy. Recuerda renovarla.",
  "Abonnement à vie : aucun renouvellement requis.":
    "Suscripción de por vida: no se requiere renovación.",
  "Avis clients": "Opiniones de clientes",
  "Partagez votre expérience avec nous sur Trustpilot":
    "Comparte tu experiencia con nosotros en Trustpilot",
  "Évaluez-nous sur Trustpilot": "Valóranos en Trustpilot",
  "Supprimer tout": "Eliminar todo",
  "Supprimer TOUTES les erreurs signalées ? Cette action est irréversible.":
    "¿Eliminar TODOS los errores reportados? Esta acción es irreversible.",

  // ===== Refonte visuelle 2026 : header / accueil / produit / dashboard =====
  "BIENVENUE SUR MBOPPI": "BIENVENIDO A MBOPPI",
  "Le marché de votre quartier, en ligne": "El mercado de tu barrio, en línea",
  "Produits des boutiques, créations des créateurs, livraison près de chez vous.":
    "Productos de tiendas, creaciones de creadores, entrega cerca de ti.",
  "Découvrir les produits": "Descubrir productos",
  "PROMOTIONS DU JOUR": "OFERTAS DE HOY",
  "Offres éclair à durée limitée": "Ofertas flash por tiempo limitado",
  "Jusqu'à -50 % sur une sélection de produits. Une seule semaine par boutique : unique !":
    "Hasta -50 % en una selección de productos. ¡Solo una semana por tienda: único!",
  "Voir les promotions": "Ver ofertas",
  "VENDEURS & BOUTIQUES": "VENDEDORES Y TIENDAS",
  "Vendez près de chez vous, sans frais de plateforme":
    "Vende cerca de ti, sin comisiones de plataforma",
  "Publiez vos produits en quelques minutes et recevez vos commandes par téléphone ou WhatsApp.":
    "Publica tus productos en minutos y recibe pedidos por teléfono o WhatsApp.",
  "Devenir vendeur": "Convertirme en vendedor",
  "PROGRAMME DE PARRAINAGE": "PROGRAMA DE REFERIDOS",
  "Gagnez 2 % sur chaque achat de vos clients affiliés":
    "Gana el 2 % en cada compra de tus clientes afiliados",
  "Partagez votre code vendeur : vos clients achètent, vous touchez 2 % automatiquement.":
    "Comparte tu código de vendedor: tus clientes compran y tú ganas el 2 % automáticamente.",
  "Créer mon compte gratuit": "Crear mi cuenta gratis",
  "À la une sur Mboppi": "Destacados en Mboppi",
  "Diapositive précédente": "Diapositiva anterior",
  "Diapositive suivante": "Diapositiva siguiente",
  "Choisir une diapositive": "Elegir diapositiva",
  Diapositive: "Diapositiva",
  "Nos garanties": "Nuestras garantías",
  "0 % de frais plateforme": "0 % de comisión de plataforma",
  "Paiements directs entre parties": "Pagos directos entre partes",
  "Paiement à la livraison": "Pago contra entrega",
  "Espèces ou Mobile Money": "Efectivo o Mobile Money",
  "Boutiques vérifiées": "Tiendas verificadas",
  "Vendeurs identifiés et notés": "Vendedores identificados y valorados",
  "Livraison suivie": "Entrega con seguimiento",
  "Code de confirmation à la remise": "Código de confirmación al entregar",
  "Défiler vers la gauche": "Desplazar a la izquierda",
  "Défiler vers la droite": "Desplazar a la derecha",
  "Vendre sur Mboppi": "Vender en Mboppi",
  "Parcourir les catégories": "Explorar categorías",
  "Liens rapides": "Enlaces rápidos",
  "Photos du produit": "Fotos del producto",
  "Navigation du tableau de bord": "Navegación del panel",
  "Indicateurs clés": "Métricas clave",
  "Produits en ligne": "Productos publicados",
  "Menu principal": "Menú principal",
  "Langues disponibles": "Idiomas disponibles",
  "Réseaux sociaux": "Redes sociales",
  "Activer le mode faible connexion (économie de données)":
    "Activar el modo de bajo consumo (ahorro de datos)",
  "Mode faible connexion (économie de données)": "Modo de bajo consumo (ahorro de datos)",
  "Mode économie actif — cliquer pour désactiver":
    "Modo de ahorro activo — haz clic para desactivar",
  /* fin refonte-A */

  // ===== Rattrapage : chaînes existantes non traduites =====
  "{n} vendus ce mois-ci": "{n} vendidos este mes",
  "{n}% de réduction": "{n}% de descuento",
  "Offre éclair": "Oferta flash",
  "se termine le {date}": "termina el {date}",
  "Satisfait ou remboursé": "Garantía de devolución",
  "Charger la photo": "Cargar foto",
  "Promotions du jour": "Ofertas de hoy",
  "Des offres à durée limitée : dépêchez-vous !": "Ofertas por tiempo limitado: ¡date prisa!",
  "Aucune promotion du jour pour le moment. Les boutiques peuvent en lancer une depuis leur espace.":
    "Todavía no hay ofertas hoy. Las tiendas pueden lanzar una desde su espacio.",
  "Meilleures ventes": "Más vendidos",
  "Tendances de la semaine": "Tendencias de la semana",
  "Vus récemment": "Vistos recientemente",
  "Reprenez là où vous vous étiez arrêté.": "Retoma donde lo dejaste.",
  "Vous n'avez pas encore consulté de produit.": "Todavía no has visto ningún producto.",
  "Les produits les plus commandés.": "Los productos más pedidos.",
  "Les produits les plus consultés ces 7 derniers jours.":
    "Los productos más vistos en los últimos 7 días.",
  "Les produits les plus consultés et commandés.": "Los productos más vistos y pedidos.",
  "⭐ Populaire": "⭐ Popular",
  "Recherche…": "Buscar…",
  "Voir tous les résultats": "Ver todos los resultados",
  "Créateur·rice": "Creador/a",
  "Code livreur": "Código de repartidor",
  "Code livreur généré : {code}": "Código de repartidor generado: {code}",
  "Générer mon code livreur": "Generar mi código de repartidor",
  "Communiquez ce code à vos livreurs : en le saisissant sur la page Livraison, ils ne verront que les livraisons (en attente et effectuées) de votre boutique.":
    "Comparte este código con tus repartidores: al introducirlo en la página de Entrega verán solo las entregas (pendientes y realizadas) de tu tienda.",
  "Promotions éclair": "Ofertas flash",
  "Proposez un produit à durée limitée (24 h maximum, une promotion par semaine). Pendant la promotion, le produit disparaît du catalogue : seul l'accès à la promotion reste possible. À la fin du temps, la promotion disparaît et le produit réapparaît s'il reste en stock.":
    "Ofrece un producto por tiempo limitado (máx. 24 h, una oferta por semana). Durante la oferta, el producto desaparece del catálogo: solo queda accesible la página de la oferta. Al terminar, la oferta desaparece y el producto reaparece si queda stock.",
  "Choisir un produit…": "Elegir un producto…",
  "⚡ Lancer la promotion": "⚡ Lanzar la oferta",
  ...
  "6 heures": "6 horas",
  "12 heures": "12 horas",
  "Promotion éclair lancée !": "¡Oferta flash lanzada!",
  "Rétirer cette promotion éclair ?": "¿Retirar esta oferta flash?",
  "Promotion rétirée.": "Oferta retirada.",
  "Lien de la promotion copié !": "¡Enlace de la oferta copiado!",
  "Aucune promotion éclair pour le moment.": "No hay ofertas flash por ahora.",
  "⚡ Offre éclair chez {shop} : {name} à {price} {symbol} au lieu de {old} {symbol} (-{pct}%) sur Mboppi.":
    "⚡ Oferta flash en {shop}: {name} por {price} {symbol} en lugar de {old} {symbol} (-{pct}%) en Mboppi.",
  "Chiffre d'affaires ({symbol})": "Ingresos ({symbol})",
  "Prix promo ({symbol})": "Precio oferta ({symbol})",
  "Commandes livrées": "Pedidos entregados",
  "Mes commandes livrées": "Mis pedidos entregados",
  "Mes produits": "Mis productos",
  "Aucune commande en attente.": "No hay pedidos pendientes.",
  "Supprimer cette livraison « {name} » de mon espace ?":
    "¿Eliminar esta entrega «{name}» de mi espacio?",
  "Parrain payé ! La preuve a été enregistrée.": "¡Referido pagado! Se guardó el comprobante.",
  "Produit « {name} » dupliqué. Pensez à modifier la copie.":
    "Producto «{name}» duplicado. Recuerda editar la copia.",
  "📋 Dupliquer": "📋 Duplicar",
  "Votre produit « {product} » a été supprimé : il ne respectait pas les CGU.":
    "Tu producto «{product}» fue eliminado: no cumplía las Condiciones de Venta.",
  "Votre produit « {product} » a été supprimé : il ne respectait pas les":
    "Tu producto «{product}» fue eliminado: no cumplía las",
};
