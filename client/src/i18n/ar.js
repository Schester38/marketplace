export default {
  ...
  "Le rôle Créateur est en cours de préparation : nous travaillons dessus et il sera bientôt disponible avec la gestion des paiements, la livraison et le suivi complet de vos ventes. En attendant, vos créations publiées restent visibles sur votre vitrine.":
    "دور المُبدِع قيد التحضير: نحن نعمل عليه وسيكون متاحاً قريباً، مع إدارة المدفوعات والتوصيل والمتابعة الكاملة لمبيعاتك. في هذه الأثناء، تبقى إبداعاتك المنشورة مرئية على واجهتك.",
  ...
  "Je livre les commandes et je reçois mes frais de livraison directement":
    "أُوصّل الطلبات وأتلقى رسوم التوصيل مباشرة",
  "Enregistrez vos portefeuilles électroniques pour recevoir vos frais de livraison en ligne.":
    "سجّل محافظك الإلكترونية لتلقي رسوم التوصيل عبر الإنترنت.",
  "C'est sur ce portefeuille que vos frais de livraison seront reversés automatiquement après chaque livraison payée en ligne.":
    "تُحوَّل رسوم التوصيل تلقائيًا إلى هذه المحفظة بعد كل توصيل يُدفع عبر الإنترنت.",
  ...
  "Commission %": "العمولة %",
  Montant: "المبلغ",
  "Donner en ligne": "التبرع عبر الإنترنت",
  "Votre opérateur": "مشغل الدفع الخاص بك",
  "Votre numéro": "رقم هاتفك",
  "vous recevrez la demande de paiement": "ستستلم طلب الدفع",
  "Le montant est prélevé sur votre mobile money et reversé automatiquement sur les portefeuilles indiqués ci-dessous.":
    "يُخصم المبلغ من محفظتك الإلكترونية ويُحوَّل تلقائيًا إلى المحافظ المذكورة أدناه.",
  "Demande de don envoyée !": "تم إرسال طلب التبرع!",
  Donner: "تبرّع",
  Manuel: "يدوي",
  ...
  "Commission en attente de cumul": "عمولة الكفالة في طور التجميع",
  "En attente — versement auto dès 5000 F": "بالانتظار — الدفع التلقائي من 5000",
  "Versement auto dès 5000 F": "الدفع التلقائي من 5000",
  "Commission parrainage": "عمولة الكفالة",
  "Paiement parrainage": "دفع الكفالة",
  Payée: "مدفوعة",
  ...
  "Chaque commande passée par un client inscrit avec votre lien vous rapporte 2% du montant. Le versement est automatique : vos commissions s'accumulent et sont payées sur votre portefeuille dès qu'elles atteignent 1500 F.":
    "كل طلب يقدمه عميل سجل عبر رابطك يمنحك 2% من المبلغ. الدفع تلقائي: تُجمّع عمولاتك وتُدفع إلى محفظتك فور بلوغها 1500.",
  ...
  "Vous avez une somme à recevoir (vente #{sale}) mais aucun portefeuille valide n'est enregistré. Ajoutez un numéro sur votre page « Mes moyens de paiement ».":
    "لديك مبلغ تستلمه (بيع #{sale}) لكن لا توجد محفظة صالحة مسجلة. أضف رقمًا في صفحة «وسائل الدفع الخاصة بي».",
  ...
  "Le site est hébergé par Vercel Inc. (340 S Lemon Ave #4133, Walnut, CA 91789, États-Unis). La base de données PostgreSQL et le stockage des images sont assurés par Supabase Inc., 1111 Broadway, Suite 1355, Oakland, CA 94607, États-Unis.":
    "الموقع مستضاف لدى Vercel Inc. قاعدة البيانات PostgreSQL وتخزين الصور توفرهما شركة Supabase Inc، 1111 Broadway, Suite 1355, Oakland, CA 94607، الولايات المتحدة.",
  ...
  "Mon lien de parrainage client": "رابط الإحالة الخاص بالعملاء",
  "Mon lien de parrainage vendeur": "رابط الإحالة الخاص بالبائعين",
  "Partagez ce lien : chaque vendeur qui s'inscrit via ce lien et active son compte (frais de 1500 F) vous fait gagner 1000 F, versés directement sur votre portefeuille Mobile Money.":
    "شارك هذا الرابط: كل بائع يسجل عبره ويفعّل حسابه (رسوم 1500 ف) يربحك 1000 ف تُحوَّل مباشرة إلى محفظة Mobile Money لديك.",
  "Deviens vendeur sur Mboppi avec mon lien et gagne le 1000 F offerts à chaque vendeur qui s'inscrit et active son compte via mon lien. Inscris-toi : {link}":
    "كن بائعاً على Mboppi عبر رابطه واربح 1000 ف عن كل بائع يسجل ويفعّل حسابه عبر رابطه. سجّل الآن: {link}",
  "Vous vous inscrivez via le lien de parrainage vendeur d'un vendeur Mboppi : le rôle « Vendeur » est sélectionné pour vous. Vous paierez les frais d'activation, et le vendeur qui vous a parrainé recevra 1000 F versés directement sur son portefeuille Mobile Money.":
    "أنت تسجل عبر رابط إحالة بائع من Mboppi: تم اختيار دور «بائع» لك. ستدفع رسوم التفعيل، والبائع الذي أحالك سيحصل على 1000 ف تُرسل مباشرة إلى محفظة Mobile Money الخاصة به.",
  ...
  "Prestataire de paiement": "مزود الدفع",
  ...
  "10. Comportement interdit": "10. السلوك الممنوع",
  "11. Suspension et résiliation": "11. التعليق والإنهاء",
  "12. Données personnelles": "12. البيانات الشخصية",
  "13. Acceptation des conditions": "13. قبول الشروط",
  ...
  "Lors de votre inscription : votre nom, votre e-mail et votre rôle (boutique, vendeur, client, livreur ou créateur). Si vous vous connectez avec Google, seul votre e-mail Google est utilisé. Selon votre rôle, vous pouvez publier des produits, des offres avec photos, et vos ventes sont enregistrées dans votre espace. Pour les paiements en ligne, nous n'utilisons que votre numéro de mobile money et votre opérateur, le temps du règlement.":
    "عند تسجيلك: اسمك وبريدك ودورك (متجر، بائع، عميل، موصّل أو مبدع). إذا دخلت عبر Google، يُستخدم بريدك في Google فقط. حسب دورك، يمكنك نشر منتجات وعروض بالصور، وتُسجل مبيعاتك في مساحتك. بالنسبة للدفعات عبر الإنترنت، نستخدم فقط رقم المال المحمول ومشغلك طوال مدة التسوية.",
  ...
  "Enregistrez votre numéro de mobile money dans votre espace, page « Paiements » (boutique, vendeur ou livreur). Après chaque paiement confirmé, Mboppi reverse automatiquement votre part : le prix pour la boutique, la commission pour le vendeur, 2% pour le parrain et les frais pour le livreur.":
    "سجل رقم المال المحمول في مساحتك، صفحة «الدفعات» (متجر أو بائع أو موصّل). بعد كل دفعة مؤكدة، يحول Mboppi تلقائياً نصيبك: الثمن للمتجر، والعمولة للبائع، و2% للكفيل، والأجور للموصّل.",
  ...
  "Rendez-vous sur la page « Soutenir Mboppi ». Les dons par Orange Money et MTN Mobile Money sont traités automatiquement en ligne ; les dons par PayPal ou par virement UBA se font manuellement.":
    "افتح صفحة «ادعم Mboppi». تُعالج التبرعات عبر Orange Money وMTN Mobile Money تلقائياً عبر الإنترنت؛ التبرعات عبر PayPal أو تحويل UBA تتم يدوياً.",
  ...
  "C'est ce numéro que vos clients utilisent pour vous contacter sur WhatsApp depuis votre vitrine. Utilisez le format international (ex : +237 6 00 00 00 00).":
    "هذا هو الرقم الذي يستخدمه عملاؤك للتواصل معك على واتساب من واجهتك. استخدم الصيغة الدولية (مثال: +237 6 00 00 00 00).",
  ...
  "Trouvez les livreurs Mboppi disponibles pour vos livraisons et contactez-les directement.":
    "اعثر على موصّلي Mboppi المتاحين لتوصيلاتك وتواصل معهم مباشرة.",
  Quartier: "الحي",
  ...
  "Laissez les champs vides pour afficher tous les livreurs disponibles.":
    "اترك الحقول فارغة لعرض جميع الموصّلين المتاحين.",
  "Recherchez par ville et quartier pour trouver des livreurs.":
    "ابحث بالمدينة والحي للعثور على موصّلين.",
  ...
  "Réglez vos frais d'activation pour commencer à vendre sur Mboppi.":
    "ادفع رسوم التفعيل لبدء البيع على Mboppi.",
  "Pour vendre sur Mboppi, réglez vos frais d'activation de {amount} {symbol}.":
    "للبيع على Mboppi، سدد رسوم التفعيل البالغة {amount} {symbol}.",
  "Frais d'activation Mensuelle": "رسوم التفعيل الشهرية",
  "Votre espace vendeur est activé pendant {days} jours à compter du paiement.":
    "يتم تفعيل مساحة البائع لمدة {days} يوماً ابتداءً من الدفع.",
  ...
  "Confirmez sur votre téléphone. Nous vous redirigeons vers votre espace dès que le paiement est détecté.":
    "أكّد على هاتفك. سنعيد توجيهك إلى مساحتك بمجرد اكتشاف الدفع.",
  ...
  "Le paiement n'a pas été effectué. Veuillez essayer à nouveau.":
    "لم يتم إتمام الدفع. يرجى المحاولة مرة أخرى.",
  ...
  "Votre abonnement expire aujourd'hui. Pensez à le renouveler.":
    "ينتهي اشتراكك اليوم. تذكّر تجديده.",
  ...
  "Supprimer TOUTES les erreurs signalées ? Cette action est irréversible.":
    "حذف جميع الأخطاء المبلغ عنها؟ هذا الإجراء لا رجعة فيه.",

  // ===== Refonte visuelle 2026 : header / accueil / produit / dashboard =====
  "BIENVENUE SUR MBOPPI": "مرحباً بك في مبوبي",
  "Le marché de votre quartier, en ligne": "سوق حيّك على الإنترنت",
  "Produits des boutiques, créations des créateurs, livraison près de chez vous.":
    "منتجات المتاجر وإبداعات المبدعين، والتوصيل قربك.",
  "Découvrir les produits": "اكتشف المنتجات",
  "PROMOTIONS DU JOUR": "عروض اليوم",
  "Offres éclair à durée limitée": "عروض خاطفة لوقت محدود",
  "Jusqu'à -50 % sur une sélection de produits. Une seule semaine par boutique : unique !":
    "حتى ‎-50٪ على مجموعة من المنتجات. أسبوع واحد فقط لكل متجر: عرض فريد!",
  "Voir les promotions": "شاهد العروض",
  "VENDEURS & BOUTIQUES": "البائعون والمتاجر",
  "Vendez près de chez vous, sans frais de plateforme": "بِع بالقرب منك دون أي عمولة على المنصة",
  "Publiez vos produits en quelques minutes et recevez vos commandes par téléphone ou WhatsApp.":
    "انشر منتجاتك في دقائق واستقبل طلباتك عبر الهاتف أو واتساب.",
  "Devenir vendeur": "كن بائعاً",
  "PROGRAMME DE PARRAINAGE": "برنامج الإحالة",
  "Gagnez 2 % sur chaque achat de vos clients affiliés":
    "اربح 2٪ على كل عملية شراء لعملائك المنتسبين",
  "Partagez votre code vendeur : vos clients achètent, vous touchez 2 % automatiquement.":
    "شارك رمز البائع الخاص بك: عندما يشتري عملاؤك تحصل تلقائياً على 2٪.",
  "Créer mon compte gratuit": "أنشئ حسابي المجاني",
  "À la une sur Mboppi": "المميّز على مبوبي",
  "Diapositive précédente": "الشريحة السابقة",
  "Diapositive suivante": "الشريحة التالية",
  "Choisir une diapositive": "اختيار شريحة",
  Diapositive: "شريحة",
  "Nos garanties": "ضماناتنا",
  "0 % de frais plateforme": "0٪ عمولة على المنصة",
  "Paiements directs entre parties": "مدفوعات مباشرة بين الأطراف",
  "Paiement à la livraison": "الدفع عند الاستلام",
  "Espèces ou Mobile Money": "نقداً أو عبر المحفظة المحمولة",
  "Boutiques vérifiées": "متاجر موثّقة",
  "Vendeurs identifiés et notés": "بائعون موثّقون ومقيَّمون",
  "Livraison suivie": "توصيل متتبَّع",
  "Code de confirmation à la remise": "رمز تأكيد عند التسليم",
  "Défiler vers la gauche": "تمرير إلى اليسار",
  "Défiler vers la droite": "تمرير إلى اليمين",
  "Vendre sur Mboppi": "بِع على مبوبي",
  "Parcourir les catégories": "تصفّح الفئات",
  "Liens rapides": "روابط سريعة",
  "Photos du produit": "صور المنتج",
  "Navigation du tableau de bord": "تنقّل لوحة التحكم",
  "Indicateurs clés": "مؤشرات رئيسية",
  "Produits en ligne": "منتجات منشورة",
  "Menu principal": "القائمة الرئيسية",
  "Langues disponibles": "اللغات المتوفرة",
  "Réseaux sociaux": "شبكات التواصل",
  "Activer le mode faible connexion (économie de données)":
    "تشغيل وضع الاتصال المنخفض (توفير البيانات)",
  "Mode faible connexion (économie de données)": "وضع الاتصال المنخفض (توفير البيانات)",
  "Mode économie actif — cliquer pour désactiver": "وضع التوفير مفعّل — انقر لإيقافه",
  /* fin refonte-A */

  // ===== Rattrapage : chaînes existantes non traduites =====
  "{n} vendus ce mois-ci": "{n} مبيعات هذا الشهر",
  "{n}% de réduction": "خصم {n}%",
  "Offre éclair": "عرض خاطف",
  "se termine le {date}": "ينتهي في {date}",
  "Satisfait ou remboursé": "ضمان استرداد الأموال",
  "Charger la photo": "تحميل الصورة",
  "Promotions du jour": "عروض اليوم",
  "Des offres à durée limitée : dépêchez-vous !": "عروض لوقت محدود: أسرِع!",
  "Aucune promotion du jour pour le moment. Les boutiques peuvent en lancer une depuis leur espace.":
    "لا توجد عروض اليوم بعد. يمكن للمتاجر إطلاق عرض من مساحتها.",
  "Meilleures ventes": "الأكثر مبيعاً",
  "Tendances de la semaine": "الأكثر رواجاً هذا الأسبوع",
  "Vus récemment": "شوهدت مؤخراً",
  "Reprenez là où vous vous étiez arrêté.": "تابع من حيث توقفت.",
  "Vous n'avez pas encore consulté de produit.": "لم تشاهد أي منتج بعد.",
  "Les produits les plus commandés.": "المنتجات الأكثر طلباً.",
  "Les produits les plus consultés ces 7 derniers jours.": "المنتجات الأكثر مشاهدة خلال 7 أيام.",
  "Les produits les plus consultés et commandés.": "المنتجات الأكثر مشاهدة وطلباً.",
  "⭐ Populaire": "⭐ شائع",
  "Recherche…": "بحث…",
  "Voir tous les résultats": "عرض كل النتائج",
  "Créateur·rice": "مبدع/ة",
  "Code livreur": "رمز الموصّل",
  "Code livreur généré : {code}": "تم إنشاء رمز الموصّل: {code}",
  "Générer mon code livreur": "إنشاء رمز الموصّل",
  "Communiquez ce code à vos livreurs : en le saisissant sur la page Livraison, ils ne verront que les livraisons (en attente et effectuées) de votre boutique.":
    "شارك هذا الرمز مع موصّليك: بإدخاله في صفحة التوصيل سيرون فقط توصيلات متجرك (المعلّقة والمنجزة).",
  "Promotions éclair": "العروض الخاطفة",
  "Proposez un produit à durée limitée (24 h maximum, une promotion par semaine). Pendant la promotion, le produit disparaît du catalogue : seul l'accès à la promotion reste possible. À la fin du temps, la promotion disparaît et le produit réapparaît s'il reste en stock.":
    "اقترح منتجاً لوقت محدود (24 ساعة كحد أقصى، عرض واحد أسبوعياً). أثناء العرض يختفي المنتج من الكتالوج: تبقى صفحة العرض وحدها متاحة. عند انتهاء الوقت يختفي العرض ويعود المنتج إذا بقي مخزوناً.",
  "Choisir un produit…": "اختر منتجاً…",
  "⚡ Lancer la promotion": "⚡ إطلاق العرض",
  "30 minutes": "30 دقيقة",
  "1 heure": "ساعة واحدة",
  "2 heures": "ساعتان",
  "3 heures": "3 ساعات",
  "6 heures": "6 ساعات",
  "12 heures": "12 ساعة",
  "Promotion éclair lancée !": "تم إطلاق العرض الخاطف!",
  "Rétirer cette promotion éclair ?": "هل تريد سحب هذا العرض الخاطف؟",
  "Promotion rétirée.": "تم سحب العرض.",
  "Lien de la promotion copié !": "تم نسخ رابط العرض!",
  "Aucune promotion éclair pour le moment.": "لا توجد عروض خاطفة حالياً.",
  "⚡ Offre éclair chez {shop} : {name} à {price} {symbol} au lieu de {old} {symbol} (-{pct}%) sur Mboppi.":
    "⚡ عرض خاطف لدى {shop}: {name} بـ {price} {symbol} بدلاً من {old} {symbol} (-{pct}%) على مبوبي.",
  "Chiffre d'affaires ({symbol})": "الإيرادات ({symbol})",
  "Prix promo ({symbol})": "سعر العرض ({symbol})",
  "Commandes livrées": "الطلبات المسلَّمة",
  "Mes commandes livrées": "طلباتي المسلَّمة",
  "Mes produits": "منتجاتي",
  "Aucune commande en attente.": "لا توجد طلبات معلّقة.",
  "Supprimer cette livraison « {name} » de mon espace ?":
    "هل تريد حذف هذا التوصيل «{name}» من مساحتي؟",
  "Parrain payé ! La preuve a été enregistrée.": "تم دفع الإحالة! تم حفظ الإثبات.",
  "Produit « {name} » dupliqué. Pensez à modifier la copie.":
    "تم تكرار المنتج «{name}». تذكّر تعديل النسخة.",
  "📋 Dupliquer": "📋 تكرار",
  "Votre produit « {product} » a été supprimé : il ne respectait pas les CGU.":
    "تم حذف منتجك «{product}»: لم يكن مطابقاً لشروط البيع.",
  "Votre produit « {product} » a été supprimé : il ne respectait pas les":
    "تم حذف منتجك «{product}»: لم يكن مطابقاً لـ",
};
