...
- Paiement : deux options. Manuel : espèces à la livraison ou virement Mobile Money/bancaire direct entre le client et la boutique. Automatique : paiement en ligne sécurisé via Ikeepay — l'acheteur paie exactement le prix affiché, sans supplément. Le livreur confirme la livraison avec le code client.
...
- Payment: two options. Manual: cash on delivery or direct Mobile Money/bank transfer between the customer and the shop. Automatic: secure online payment via Ikeepay — the buyer pays exactly the displayed price, with no extra charge. The rider confirms delivery with the customer's code.
...
- الدفع: خياران. يدوي: نقداً عند التسليم أو تحويل Mobile Money/بنكي مباشر بين العميل والمتجر. تلقائي: دفع آمن عبر الإنترنت عبر Ikeepay — يدفع المشتري السعر المعروض بالضبط دون أي إضافة. يؤكد الموصّل التسليم برمز العميل.
