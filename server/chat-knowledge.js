...
- Paiement : les règlements se font au moment de la livraison (espèces ou Mobile Money) OU en ligne via iKeePay, le partenaire de paiement officiel de Mboppi. Le paiement en ligne se déclenche sur la commande (paiement « en ligne ») : iKeePay envoie une demande de paiement sur le numéro Mobile Money du client (Orange Money, MTN Mobile Money, Wave, Moov Money, M-Pesa, etc.). Aucune carte bancaire n'est jamais demandée ni acceptée. La part iKeePay (6 %) est incluse dans le montant demandé : le client paie le total majoré des frais, la boutique et les vendeurs reçoivent leurs montants nets.
...
- Payment: settlements happen at delivery (cash or mobile money) OR online via iKeePay, Mboppi's official payment partner. Online payment is triggered from the order (pay online option): iKeePay sends a payment request to the customer's mobile money number (Orange Money, MTN Mobile Money, Wave, Moov Money, M-Pesa, etc.). A credit card is never requested or accepted. The iKeePay share (6%) is included in the requested amount: the customer pays the total plus fees, and shops and sellers receive their net amounts.
...
- الدفع: تُسدَّد المدفوعات عند التوصيل (نقداً أو عبر المحفظة الإلكترونية) أو عبر الإنترنت بواسطة iKeePay، شريك الدفع الرسمي لمبوّي. يتم الدفع عبر الإنترنت من الطلب (خيار الدفع أونلاين): يرسل iKeePay طلب دفع إلى رقم المحفظة الإلكترونية للعميل (أورنج موني، إم تي إن موبايل موني، ويف، موف موني، إم بيسا...). لا تُطلب بطاقة بنكية أبداً ولا تُقبل. حصة iKeePay (6٪) مشمولة في المبلغ المطلوب: يدفع العميل الإجمالي بالإضافة إلى الرسوم، وتتلقى المتاجر والباعة مبالغهم صافية.
