...
// Checkout hébergé officiel iKeePay : le client choisit lui-même son opérateur
// sur la page iKeePay. D'après leur intégration documentée, seuls pk, amount,
// currency, order_id, email et redirect_url sont lus — pas de clé secrète.
...
export function inlineCheckoutUrl({ amount, currency, orderId, email, redirectUrl }) {
