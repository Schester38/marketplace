...
const COUNTRY_CODES = {
  Cameroun: 'CM', "Côte d'Ivoire": 'CI', Sénégal: 'SN', Mali: 'ML',
  'Burkina Faso': 'BF', Niger: 'NE', Togo: 'TG', Bénin: 'BJ', Guinée: 'GN',
  Gabon: 'GA', 'République du Congo': 'CG', 'République démocratique du Congo': 'CD',
  Kenya: 'KE', Tanzanie: 'TZ', Rwanda: 'RW', Ouganda: 'UG', Zambie: 'ZM', Ghana: 'GH',
  Nigeria: 'NG', 'Sierra Leone': 'SL',
};

const CURRENCY_BY_COUNTRY = {
  CM: 'XAF', CI: 'XOF', SN: 'XOF', ML: 'XOF', BF: 'XOF', NE: 'XOF', TG: 'XOF', BJ: 'XOF',
  GN: 'GNF', GA: 'XAF', CG: 'XAF', CD: 'CDF', KE: 'KES', TZ: 'TZS', RW: 'RWF', UG: 'UGX',
  ZM: 'ZMW', GH: 'GHS', NG: 'NGN', SL: 'SLE',
};
...
export function normalizePhone(phone, country) {
  ...
  const code = countryCode(country);
  const prefixes = { CM: '237', CI: '225', SN: '221', ML: '223', BF: '226', NE: '227', TG: '228', BJ: '229', GN: '224', GA: '241', CG: '242', CD: '243', KE: '254', TZ: '255', RW: '250', UG: '256', ZM: '260', GH: '233', NG: '234', SL: '232' };
