...
const PUBLIC_KEY = process.env.VAPID_PUBLIC_KEY || 'BBK3xusBTGqDyRbKazYQjgCdnhjfdPG0xqfmyumtxklh7TlFjMWT4F79Alfs8Tqc-No6sXoDpEuwMMDRpeESsTg';
const PRIVATE_KEY = process.env.VAPID_PRIVATE_KEY || '-AStrAAsQe7a3pDQWx57pErO-dBpIjiN76zHtci6Oeo';
